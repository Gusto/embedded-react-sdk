...
import { sdkConventions, tsdocCoverage } from './eslint-rules/plugins'
...
export default [
  ...
  /**
   * Route all Gusto Embedded API imports through the version-agnostic
   * `@gusto/embedded-api` alias. Skips `src/models/external.ts`, which is
   * generated by `build/deriveExternalModels.ts` (fix it at the generator).
   */
  {
    plugins: { 'sdk-conventions': sdkConventions },
    ignores: ['src/models/external.ts'],
    rules: {
      'sdk-conventions/use-embedded-api-alias': 'error',
    },
  },
  /** Library: autogenerated documentation demands TSDoc quality & coverage. */
  {
