...
import { EmployeeHomeAddressHistoryEntry$inboundSchema, } from "./employeehomeaddresshistoryentry.js";
...
/** @internal */
export const ShowEmployeesOnboardingStatus$inboundSchema = z.nativeEnum(ShowEmployeesOnboardingStatus);
/** @internal */
export const ShowEmployeesOnboardingDocumentsConfig$inboundSchema = z.object({
...
export function showEmployeesOnboardingDocumentsConfigFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ShowEmployeesOnboardingDocumentsConfig$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ShowEmployeesOnboardingDocumentsConfig' from JSON`);
}
/** @internal */
export const ShowEmployeesPaymentMethod$inboundSchema = z.nativeEnum(ShowEmployeesPaymentMethod);
/** @internal */
export const ShowEmployeesCurrentEmploymentStatus$inboundSchema = z.nativeEnum(ShowEmployeesCurrentEmploymentStatus);
/** @internal */
export const ShowEmployeesStatus$inboundSchema = z.nativeEnum(ShowEmployeesStatus);
/** @internal */
export const ShowEmployeesMemberPortalInvitationStatus$inboundSchema = z.object({
...
export function showEmployeesMemberPortalInvitationStatusFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ShowEmployeesMemberPortalInvitationStatus$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ShowEmployeesMemberPortalInvitationStatus' from JSON`);
}
/** @internal */
export const ShowEmployees$inboundSchema = collectExtraKeys$(z.object({
    ...
    onboarding_status: z.nullable(ShowEmployeesOnboardingStatus$inboundSchema)
        .optional(),
    onboarding_documents_config: z.lazy(() => ShowEmployeesOnboardingDocumentsConfig$inboundSchema).optional(),
    ...
    current_employment_status: z.nullable(ShowEmployeesCurrentEmploymentStatus$inboundSchema).optional(),
    ...
    member_portal_invitation_status: z.nullable(z.lazy(() => ShowEmployeesMemberPortalInvitationStatus$inboundSchema)).optional(),
