...
/** @internal */
export declare const PayrollReceiptTotals$inboundSchema: z.ZodType<PayrollReceiptTotals, z.ZodTypeDef, unknown>;
export declare function payrollReceiptTotalsFromJSON(jsonString: string): SafeParseResult<PayrollReceiptTotals, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const PayrollReceiptLicensee$inboundSchema: z.ZodType<PayrollReceiptLicensee, z.ZodTypeDef, unknown>;
export declare function payrollReceiptLicenseeFromJSON(jsonString: string): SafeParseResult<PayrollReceiptLicensee, SDKValidationError>;
/** @internal */
