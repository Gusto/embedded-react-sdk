...
/** @internal */
export const PayrollReceiptTotals$inboundSchema = z.object({
...
export function payrollReceiptTotalsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => PayrollReceiptTotals$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'PayrollReceiptTotals' from JSON`);
}
/** @internal */
...
/** @internal */
export const PayrollReceiptLicensee$inboundSchema = z.object({
    name: z.string().optional(),
...
export function payrollReceiptLicenseeFromJSON(jsonString) {
    return safeParse(jsonString, (x) => PayrollReceiptLicensee$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'PayrollReceiptLicensee' from JSON`);
}
/** @internal */
