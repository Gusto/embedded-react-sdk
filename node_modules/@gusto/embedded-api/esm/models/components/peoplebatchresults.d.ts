...
/** @internal */
export declare const PeopleBatchResultsResultsErrors$inboundSchema: z.ZodType<PeopleBatchResultsResultsErrors, z.ZodTypeDef, unknown>;
export declare function peopleBatchResultsResultsErrorsFromJSON(jsonString: string): SafeParseResult<PeopleBatchResultsResultsErrors, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const PeopleBatchResultsResults$inboundSchema: z.ZodType<PeopleBatchResultsResults, z.ZodTypeDef, unknown>;
export declare function peopleBatchResultsResultsFromJSON(jsonString: string): SafeParseResult<PeopleBatchResultsResults, SDKValidationError>;
/** @internal */
export declare const PeopleBatchResultsExclusions$inboundSchema: z.ZodType<PeopleBatchResultsExclusions, z.ZodTypeDef, unknown>;
export declare function peopleBatchResultsExclusionsFromJSON(jsonString: string): SafeParseResult<PeopleBatchResultsExclusions, SDKValidationError>;
/** @internal */
