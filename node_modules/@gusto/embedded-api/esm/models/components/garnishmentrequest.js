...
import { GarnishmentChildSupport$outboundSchema, } from "./garnishmentchildsupport.js";
...
/** @internal */
export const GarnishmentRequestGarnishmentType$outboundSchema = z.nativeEnum(GarnishmentRequestGarnishmentType);
/** @internal */
export const GarnishmentRequest$outboundSchema = z.object({
...
export function garnishmentRequestToJSON(garnishmentRequest) {
    return JSON.stringify(GarnishmentRequest$outboundSchema.parse(garnishmentRequest));
}
//# sourceMappingURL=garnishmentrequest.js.map