...
import { EmployeeHomeAddressHistoryEntry } from "./employeehomeaddresshistoryentry.js";
...
export declare const ShowEmployeesOnboardingStatus: {
...
export type ShowEmployeesOnboardingStatus = ClosedEnum<typeof ShowEmployeesOnboardingStatus>;
/**
 ...
 */
export declare const ShowEmployeesPaymentMethod: {
 ...
 * The employee's payment method
 */
export type ShowEmployeesPaymentMethod = ClosedEnum<typeof ShowEmployeesPaymentMethod>;
export declare const ShowEmployeesCurrentEmploymentStatus: {
...
export type ShowEmployeesCurrentEmploymentStatus = ClosedEnum<typeof ShowEmployeesCurrentEmploymentStatus>;
/**
...
export type ShowEmployees = {
     ...
     * Configuration for an employee onboarding documents during onboarding
     */
    onboardingDocumentsConfig?: ShowEmployeesOnboardingDocumentsConfig | undefined;
     ...
     */
    currentEmploymentStatus?: ShowEmployeesCurrentEmploymentStatus | null | undefined;
     ...
     * Member portal invitation status information. Only included when the include param has the portal_invitations value set.
     */
    memberPortalInvitationStatus?: ShowEmployeesMemberPortalInvitationStatus | null | undefined;
    /**
...
/** @internal */
export declare const ShowEmployeesOnboardingStatus$inboundSchema: z.ZodNativeEnum<typeof ShowEmployeesOnboardingStatus>;
/** @internal */
export declare const ShowEmployeesOnboardingDocumentsConfig$inboundSchema: z.ZodType<ShowEmployeesOnboardingDocumentsConfig, z.ZodTypeDef, unknown>;
export declare function showEmployeesOnboardingDocumentsConfigFromJSON(jsonString: string): SafeParseResult<ShowEmployeesOnboardingDocumentsConfig, SDKValidationError>;
/** @internal */
export declare const ShowEmployeesPaymentMethod$inboundSchema: z.ZodNativeEnum<typeof ShowEmployeesPaymentMethod>;
/** @internal */
export declare const ShowEmployeesCurrentEmploymentStatus$inboundSchema: z.ZodNativeEnum<typeof ShowEmployeesCurrentEmploymentStatus>;
/** @internal */
export declare const ShowEmployeesStatus$inboundSchema: z.ZodNativeEnum<typeof ShowEmployeesStatus>;
/** @internal */
export declare const ShowEmployeesMemberPortalInvitationStatus$inboundSchema: z.ZodType<ShowEmployeesMemberPortalInvitationStatus, z.ZodTypeDef, unknown>;
export declare function showEmployeesMemberPortalInvitationStatusFromJSON(jsonString: string): SafeParseResult<ShowEmployeesMemberPortalInvitationStatus, SDKValidationError>;
/** @internal */
