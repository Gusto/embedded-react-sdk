 ...
 */
export declare const PayrollUpdateOverrideType: {
    readonly OneTime: "one_time";
};
/**
 * Override mode. Only `one_time` is currently supported.
 */
export type PayrollUpdateOverrideType = ClosedEnum<typeof PayrollUpdateOverrideType>;
/**
 * How to interpret the amount.
 */
export declare const PayrollUpdateEmployeeCompensationsAmountType: {
    readonly Fixed: "fixed";
    readonly Percent: "percent";
};
/**
 * How to interpret the amount.
 */
export type PayrollUpdateEmployeeCompensationsAmountType = ClosedEnum<typeof PayrollUpdateEmployeeCompensationsAmountType>;
/**
 ...
 * Override mode. Only `one_time` is currently supported.
 */
export declare const PayrollUpdateEmployeeCompensationsOverrideType: {
    readonly OneTime: "one_time";
};
/**
 * Override mode. Only `one_time` is currently supported.
 */
export type PayrollUpdateEmployeeCompensationsOverrideType = ClosedEnum<typeof PayrollUpdateEmployeeCompensationsOverrideType>;
/**
 * How to interpret the amount.
 */
export declare const PayrollUpdateEmployeeCompensationsCustomWithholdingsAmountType: {
    readonly Fixed: "fixed";
    readonly Percent: "percent";
};
/**
 * How to interpret the amount.
 */
export type PayrollUpdateEmployeeCompensationsCustomWithholdingsAmountType = ClosedEnum<typeof PayrollUpdateEmployeeCompensationsCustomWithholdingsAmountType>;
export type PayrollUpdateState = {
     ...
     * How to interpret the amount.
     */
    amountType?: PayrollUpdateEmployeeCompensationsCustomWithholdingsAmountType | undefined;
};
/**
...
/** @internal */
export declare const PayrollUpdateBreakdowns$outboundSchema: z.ZodType<PayrollUpdateBreakdowns$Outbound, z.ZodTypeDef, PayrollUpdateBreakdowns>;
export declare function payrollUpdateBreakdownsToJSON(payrollUpdateBreakdowns: PayrollUpdateBreakdowns): string;
/** @internal */
...
/** @internal */
export declare const PayrollUpdateEmployeeCompensationsBreakdowns$outboundSchema: z.ZodType<PayrollUpdateEmployeeCompensationsBreakdowns$Outbound, z.ZodTypeDef, PayrollUpdateEmployeeCompensationsBreakdowns>;
export declare function payrollUpdateEmployeeCompensationsBreakdownsToJSON(payrollUpdateEmployeeCompensationsBreakdowns: PayrollUpdateEmployeeCompensationsBreakdowns): string;
/** @internal */
export type PayrollUpdateHourlyCompensations$Outbound = {
    name?: string | undefined;
    hours?: string | undefined;
    job_uuid?: string | undefined;
    breakdowns?: Array<PayrollUpdateEmployeeCompensationsBreakdowns$Outbound> | undefined;
};
/** @internal */
...
/** @internal */
export declare const PayrollUpdateOverrideType$outboundSchema: z.ZodNativeEnum<typeof PayrollUpdateOverrideType>;
/** @internal */
export declare const PayrollUpdateEmployeeCompensationsAmountType$outboundSchema: z.ZodNativeEnum<typeof PayrollUpdateEmployeeCompensationsAmountType>;
/** @internal */
...
/** @internal */
export declare const PayrollUpdateFederal$outboundSchema: z.ZodType<PayrollUpdateFederal$Outbound, z.ZodTypeDef, PayrollUpdateFederal>;
export declare function payrollUpdateFederalToJSON(payrollUpdateFederal: PayrollUpdateFederal): string;
/** @internal */
export declare const PayrollUpdateEmployeeCompensationsOverrideType$outboundSchema: z.ZodNativeEnum<typeof PayrollUpdateEmployeeCompensationsOverrideType>;
/** @internal */
export declare const PayrollUpdateEmployeeCompensationsCustomWithholdingsAmountType$outboundSchema: z.ZodNativeEnum<typeof PayrollUpdateEmployeeCompensationsCustomWithholdingsAmountType>;
/** @internal */
...
/** @internal */
export declare const PayrollUpdateState$outboundSchema: z.ZodType<PayrollUpdateState$Outbound, z.ZodTypeDef, PayrollUpdateState>;
export declare function payrollUpdateStateToJSON(payrollUpdateState: PayrollUpdateState): string;
/** @internal */
...
/** @internal */
export declare const PayrollUpdateCustomWithholdings$outboundSchema: z.ZodType<PayrollUpdateCustomWithholdings$Outbound, z.ZodTypeDef, PayrollUpdateCustomWithholdings>;
export declare function payrollUpdateCustomWithholdingsToJSON(payrollUpdateCustomWithholdings: PayrollUpdateCustomWithholdings): string;
/** @internal */
