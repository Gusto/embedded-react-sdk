 ...
 */
export declare const RehireBodyEmploymentStatus: {
 ...
 * The employee's employment status. Supplying an invalid option will set the employment_status to *not_set*.
 */
export type RehireBodyEmploymentStatus = ClosedEnum<typeof RehireBodyEmploymentStatus>;
...
/** @internal */
export declare const RehireBodyEmploymentStatus$outboundSchema: z.ZodNativeEnum<typeof RehireBodyEmploymentStatus>;
/** @internal */
