...
export declare const CompanyOnboardingStatusRequirements: {
    readonly AddAddresses: "add_addresses";
    readonly FederalTaxSetup: "federal_tax_setup";
    readonly SelectIndustry: "select_industry";
    readonly AddBankInfo: "add_bank_info";
...
export type CompanyOnboardingStatusRequirements = ClosedEnum<typeof CompanyOnboardingStatusRequirements>;
...
/** @internal */
export declare const CompanyOnboardingStatusRequirements$inboundSchema: z.ZodNativeEnum<typeof CompanyOnboardingStatusRequirements>;
/** @internal */
