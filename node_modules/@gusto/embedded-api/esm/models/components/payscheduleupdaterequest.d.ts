 ...
 */
export declare const PayScheduleUpdateRequestFrequency: {
 ...
 * - `Monthly`: One pay date per month; require day_1 (1-31).
 */
export type PayScheduleUpdateRequestFrequency = ClosedEnum<typeof PayScheduleUpdateRequestFrequency>;
/**
 * The day of the week that this pay schedule's workweeks start on, used for regular rate of pay overtime calculations.
 *
 * @remarks
 */
export declare const PayScheduleUpdateRequestWorkweekStartDay: {
 ...
 * @remarks
 */
export type PayScheduleUpdateRequestWorkweekStartDay = ClosedEnum<typeof PayScheduleUpdateRequestWorkweekStartDay>;
/**
...
/** @internal */
export declare const PayScheduleUpdateRequestFrequency$outboundSchema: z.ZodNativeEnum<typeof PayScheduleUpdateRequestFrequency>;
/** @internal */
export declare const PayScheduleUpdateRequestWorkweekStartDay$outboundSchema: z.ZodNativeEnum<typeof PayScheduleUpdateRequestWorkweekStartDay>;
/** @internal */
