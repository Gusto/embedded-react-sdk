...
/** @internal */
export const EmployeeBenefitContribution$inboundSchema = z.object({
    type: z.string().optional(),
    value: z.union([z.string(), z.lazy(() => Two$inboundSchema)]).optional(),
});
export function employeeBenefitContributionFromJSON(jsonString) {
    return safeParse(jsonString, (x) => EmployeeBenefitContribution$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'EmployeeBenefitContribution' from JSON`);
}
/** @internal */
export const DeductionReducesTaxableIncome$inboundSchema = z.nativeEnum(DeductionReducesTaxableIncome);
/** @internal */
export const EmployeeBenefit$inboundSchema = collectExtraKeys$(z.object({
    ...
    deduction_reduces_taxable_income: z.nullable(DeductionReducesTaxableIncome$inboundSchema).optional(),
