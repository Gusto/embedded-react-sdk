...
/** @internal */
export declare const EmployeeBenefitContribution$inboundSchema: z.ZodType<EmployeeBenefitContribution, z.ZodTypeDef, unknown>;
export declare function employeeBenefitContributionFromJSON(jsonString: string): SafeParseResult<EmployeeBenefitContribution, SDKValidationError>;
/** @internal */
