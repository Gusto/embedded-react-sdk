...
export const FileType$outboundSchema = z
    .nativeEnum(FileType);
/** @internal */
export const DateFilterType$outboundSchema = z.nativeEnum(DateFilterType);
/** @internal */
...
/** @internal */
export const BulkReportCustomReportItem$outboundSchema = z.object({
...
export function bulkReportCustomReportItemToJSON(bulkReportCustomReportItem) {
    return JSON.stringify(BulkReportCustomReportItem$outboundSchema.parse(bulkReportCustomReportItem));
}
//# sourceMappingURL=bulkreportcustomreportitem.js.map