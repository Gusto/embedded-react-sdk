...
/** @internal */
export declare const PayScheduleAssignmentBodyEmployees$outboundSchema: z.ZodType<PayScheduleAssignmentBodyEmployees$Outbound, z.ZodTypeDef, PayScheduleAssignmentBodyEmployees>;
export declare function payScheduleAssignmentBodyEmployeesToJSON(payScheduleAssignmentBodyEmployees: PayScheduleAssignmentBodyEmployees): string;
/** @internal */
