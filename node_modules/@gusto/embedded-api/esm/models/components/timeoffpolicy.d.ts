...
export declare const PolicyType: {
    ...
    readonly FloatingHoliday: "floating_holiday";
    readonly JuryDuty: "jury_duty";
    readonly LearningAndDevelopment: "learning_and_development";
    readonly ParentalLeave: "parental_leave";
    readonly PersonalDay: "personal_day";
