 ...
 */
export declare const PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion = ClosedEnum<typeof PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion>;
/**
 * Payroll type
 */
...
export type PostCompaniesPayrollSkipCompanyUuidRequest = {
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion | undefined;
    /**
...
/** @internal */
export declare const PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion>;
/** @internal */
