 ...
 */
export declare const PutV1EmployeeFormSignHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PutV1EmployeeFormSignHeaderXGustoAPIVersion = ClosedEnum<typeof PutV1EmployeeFormSignHeaderXGustoAPIVersion>;
...
/** @internal */
export declare const PutV1EmployeeFormSignHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PutV1EmployeeFormSignHeaderXGustoAPIVersion>;
/** @internal */
