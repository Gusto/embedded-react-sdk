 ...
 */
export declare const PostV1SandboxGenerate1099HeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PostV1SandboxGenerate1099HeaderXGustoAPIVersion = ClosedEnum<typeof PostV1SandboxGenerate1099HeaderXGustoAPIVersion>;
...
export type PostV1SandboxGenerate1099Request = {
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: PostV1SandboxGenerate1099HeaderXGustoAPIVersion | undefined;
...
/** @internal */
export declare const PostV1SandboxGenerate1099HeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PostV1SandboxGenerate1099HeaderXGustoAPIVersion>;
/** @internal */
