 ...
 */
export declare const OauthAccessTokenHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type OauthAccessTokenHeaderXGustoAPIVersion = ClosedEnum<typeof OauthAccessTokenHeaderXGustoAPIVersion>;
...
/** @internal */
export declare const OauthAccessTokenHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof OauthAccessTokenHeaderXGustoAPIVersion>;
/** @internal */
