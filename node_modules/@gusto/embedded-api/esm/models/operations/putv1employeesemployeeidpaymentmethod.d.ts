 ...
 */
export declare const PutV1EmployeesEmployeeIdPaymentMethodType: {
 ...
 * The payment method type. If type is Check, split_by and splits do not need to be populated. If type is Direct Deposit, split_by and splits are required.
 */
export type PutV1EmployeesEmployeeIdPaymentMethodType = ClosedEnum<typeof PutV1EmployeesEmployeeIdPaymentMethodType>;
...
/** @internal */
export declare const PutV1EmployeesEmployeeIdPaymentMethodType$outboundSchema: z.ZodNativeEnum<typeof PutV1EmployeesEmployeeIdPaymentMethodType>;
/** @internal */
