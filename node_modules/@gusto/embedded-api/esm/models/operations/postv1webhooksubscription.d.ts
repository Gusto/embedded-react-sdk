 ...
 */
export declare const PostV1WebhookSubscriptionHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PostV1WebhookSubscriptionHeaderXGustoAPIVersion = ClosedEnum<typeof PostV1WebhookSubscriptionHeaderXGustoAPIVersion>;
...
export type PostV1WebhookSubscriptionRequest = {
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: PostV1WebhookSubscriptionHeaderXGustoAPIVersion | undefined;
...
/** @internal */
export declare const PostV1WebhookSubscriptionHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PostV1WebhookSubscriptionHeaderXGustoAPIVersion>;
/** @internal */
