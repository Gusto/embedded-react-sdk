 ...
 */
export declare const GetV1EmployeesEmployeeIdEmployeeBenefitsHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetV1EmployeesEmployeeIdEmployeeBenefitsHeaderXGustoAPIVersion = ClosedEnum<typeof GetV1EmployeesEmployeeIdEmployeeBenefitsHeaderXGustoAPIVersion>;
/**
 * Available options:
 *
 * @remarks
...
export type GetV1EmployeesEmployeeIdEmployeeBenefitsRequest = {
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: GetV1EmployeesEmployeeIdEmployeeBenefitsHeaderXGustoAPIVersion | undefined;
    /**
...
/** @internal */
export declare const GetV1EmployeesEmployeeIdEmployeeBenefitsHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof GetV1EmployeesEmployeeIdEmployeeBenefitsHeaderXGustoAPIVersion>;
/** @internal */
