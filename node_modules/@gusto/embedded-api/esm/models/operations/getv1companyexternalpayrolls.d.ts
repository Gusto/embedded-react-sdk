 ...
 */
export declare const GetV1CompanyExternalPayrollsHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetV1CompanyExternalPayrollsHeaderXGustoAPIVersion = ClosedEnum<typeof GetV1CompanyExternalPayrollsHeaderXGustoAPIVersion>;
export type GetV1CompanyExternalPayrollsRequest = {
    /**
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: GetV1CompanyExternalPayrollsHeaderXGustoAPIVersion | undefined;
    /**
...
/** @internal */
export declare const GetV1CompanyExternalPayrollsHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof GetV1CompanyExternalPayrollsHeaderXGustoAPIVersion>;
/** @internal */
