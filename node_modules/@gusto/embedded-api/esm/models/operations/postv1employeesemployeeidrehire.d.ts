 ...
 */
export declare const PostV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PostV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion = ClosedEnum<typeof PostV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion>;
export type PostV1EmployeesEmployeeIdRehireRequest = {
    /**
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: PostV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion | undefined;
    /**
...
/** @internal */
export declare const PostV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PostV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion>;
/** @internal */
