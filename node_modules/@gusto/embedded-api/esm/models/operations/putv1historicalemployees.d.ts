 ...
 */
export declare const PutV1HistoricalEmployeesHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PutV1HistoricalEmployeesHeaderXGustoAPIVersion = ClosedEnum<typeof PutV1HistoricalEmployeesHeaderXGustoAPIVersion>;
/**
...
/** @internal */
export declare const PutV1HistoricalEmployeesHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PutV1HistoricalEmployeesHeaderXGustoAPIVersion>;
/** @internal */
