 ...
 */
export declare const GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion = ClosedEnum<typeof GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion>;
/**
 * Available options:
 *
 * @remarks
...
/** @internal */
export declare const GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion>;
/** @internal */
