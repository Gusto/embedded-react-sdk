 ...
 */
export declare const PutV1ContractorDocumentSignHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PutV1ContractorDocumentSignHeaderXGustoAPIVersion = ClosedEnum<typeof PutV1ContractorDocumentSignHeaderXGustoAPIVersion>;
export type Fields = {
    /**
...
export type PutV1ContractorDocumentSignRequest = {
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: PutV1ContractorDocumentSignHeaderXGustoAPIVersion | undefined;
    /**
...
/** @internal */
export declare const PutV1ContractorDocumentSignHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PutV1ContractorDocumentSignHeaderXGustoAPIVersion>;
/** @internal */
