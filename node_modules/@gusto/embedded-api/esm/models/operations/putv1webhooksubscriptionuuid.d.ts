 ...
 */
export declare const PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion = ClosedEnum<typeof PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion>;
export declare const PutV1WebhookSubscriptionUuidSubscriptionTypes: {
    ...
    readonly PeopleBatch: "PeopleBatch";
...
export type PutV1WebhookSubscriptionUuidRequest = {
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion | undefined;
    /**
...
/** @internal */
export declare const PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion>;
/** @internal */
