 ...
 */
export declare const GetInvoicesInvoicePeriodHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetInvoicesInvoicePeriodHeaderXGustoAPIVersion = ClosedEnum<typeof GetInvoicesInvoicePeriodHeaderXGustoAPIVersion>;
...
/** @internal */
export declare const GetInvoicesInvoicePeriodHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof GetInvoicesInvoicePeriodHeaderXGustoAPIVersion>;
/** @internal */
