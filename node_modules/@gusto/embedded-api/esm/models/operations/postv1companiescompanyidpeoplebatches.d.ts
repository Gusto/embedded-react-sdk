 ...
 */
export declare const PostV1CompaniesCompanyIdPeopleBatchesBatchAction: {
    readonly Create: "create";
};
/**
 * The action to perform on the batch
 */
export type PostV1CompaniesCompanyIdPeopleBatchesBatchAction = ClosedEnum<typeof PostV1CompaniesCompanyIdPeopleBatchesBatchAction>;
/**
 * The type of entity to create
 */
export declare const PostV1CompaniesCompanyIdPeopleBatchesEntityType: {
    readonly Employee: "employee";
};
/**
 * The type of entity to create
 */
export type PostV1CompaniesCompanyIdPeopleBatchesEntityType = ClosedEnum<typeof PostV1CompaniesCompanyIdPeopleBatchesEntityType>;
export type Person = {
    /**
...
/** @internal */
export declare const PostV1CompaniesCompanyIdPeopleBatchesBatchAction$outboundSchema: z.ZodNativeEnum<typeof PostV1CompaniesCompanyIdPeopleBatchesBatchAction>;
/** @internal */
export declare const PostV1CompaniesCompanyIdPeopleBatchesEntityType$outboundSchema: z.ZodNativeEnum<typeof PostV1CompaniesCompanyIdPeopleBatchesEntityType>;
/** @internal */
...
/** @internal */
export declare const PostV1CompaniesCompanyIdPeopleBatchesBatch$outboundSchema: z.ZodType<PostV1CompaniesCompanyIdPeopleBatchesBatch$Outbound, z.ZodTypeDef, PostV1CompaniesCompanyIdPeopleBatchesBatch>;
export declare function postV1CompaniesCompanyIdPeopleBatchesBatchToJSON(postV1CompaniesCompanyIdPeopleBatchesBatch: PostV1CompaniesCompanyIdPeopleBatchesBatch): string;
/** @internal */
