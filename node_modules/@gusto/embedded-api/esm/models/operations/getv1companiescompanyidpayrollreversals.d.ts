 ...
 */
export declare const GetV1CompaniesCompanyIdPayrollReversalsHeaderXGustoAPIVersion: {
    readonly TwoThousandAndTwentySixMinus06Minus15: "2026-06-15";
};
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetV1CompaniesCompanyIdPayrollReversalsHeaderXGustoAPIVersion = ClosedEnum<typeof GetV1CompaniesCompanyIdPayrollReversalsHeaderXGustoAPIVersion>;
export type GetV1CompaniesCompanyIdPayrollReversalsRequest = {
    /**
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    xGustoAPIVersion?: GetV1CompaniesCompanyIdPayrollReversalsHeaderXGustoAPIVersion | undefined;
    /**
...
/** @internal */
export declare const GetV1CompaniesCompanyIdPayrollReversalsHeaderXGustoAPIVersion$outboundSchema: z.ZodNativeEnum<typeof GetV1CompaniesCompanyIdPayrollReversalsHeaderXGustoAPIVersion>;
/** @internal */
