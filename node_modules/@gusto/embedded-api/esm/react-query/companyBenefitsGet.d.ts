...
import { GetV1CompanyBenefitsCompanyBenefitIdHeaderXGustoAPIVersion, GetV1CompanyBenefitsCompanyBenefitIdRequest, Include } from "../models/operations/getv1companybenefitscompanybenefitid.js";
...
export type CompanyBenefitsGetQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setCompanyBenefitsGetData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1CompanyBenefitsCompanyBenefitIdHeaderXGustoAPIVersion | undefined;
