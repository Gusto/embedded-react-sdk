...
import { GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsHeaderXGustoAPIVersion, GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsRequest, QueryParamInclude } from "../models/operations/getv1companybenefitscompanybenefitidemployeebenefits.js";
...
export type CompanyBenefitsGetEmployeeBenefitsQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setCompanyBenefitsGetEmployeeBenefitsData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsHeaderXGustoAPIVersion | undefined;
