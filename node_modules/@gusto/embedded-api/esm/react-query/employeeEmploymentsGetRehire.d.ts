...
import { GetV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion, GetV1EmployeesEmployeeIdRehireRequest } from "../models/operations/getv1employeesemployeeidrehire.js";
...
export type EmployeeEmploymentsGetRehireQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setEmployeeEmploymentsGetRehireData(client: QueryClient, queryKeyBase: [
    employeeId: string,
    parameters: {
        xGustoAPIVersion?: GetV1EmployeesEmployeeIdRehireHeaderXGustoAPIVersion | undefined;
    }
