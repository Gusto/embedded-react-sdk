...
import { GetCompaniesCompanyUuidReportTemplatesReportTypeHeaderXGustoAPIVersion, GetCompaniesCompanyUuidReportTemplatesReportTypeRequest } from "../models/operations/getcompaniescompanyuuidreporttemplatesreporttype.js";
...
export type ReportsGetTemplateQueryError = NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setReportsGetTemplateData(client: QueryClient, queryKeyBase: [
    ...
    reportType: string,
    parameters: {
        xGustoAPIVersion?: GetCompaniesCompanyUuidReportTemplatesReportTypeHeaderXGustoAPIVersion | undefined;
    }
