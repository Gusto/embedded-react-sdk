...
import { GetNotificationsNotificationUuidHeaderXGustoAPIVersion, GetNotificationsNotificationUuidRequest } from "../models/operations/getnotificationsnotificationuuid.js";
...
export type NotificationsGetDetailsQueryError = NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setNotificationsGetDetailsData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetNotificationsNotificationUuidHeaderXGustoAPIVersion | undefined;
    }
