...
import { GetEventsHeaderXGustoAPIVersion, GetEventsRequest, GetEventsSecurity, SortOrder } from "../models/operations/getevents.js";
...
export type EventsGetQueryError = UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * Get all events
 *
 * @remarks
