...
import { GetV1CompaniesCompanyUuidTaxRequirementsHeaderXGustoAPIVersion, GetV1CompaniesCompanyUuidTaxRequirementsRequest, GetV1CompaniesCompanyUuidTaxRequirementsResponse } from "../models/operations/getv1companiescompanyuuidtaxrequirements.js";
...
export declare function queryKeyTaxRequirementsGetAll(companyUuid: string, parameters: {
    xGustoAPIVersion?: GetV1CompaniesCompanyUuidTaxRequirementsHeaderXGustoAPIVersion | undefined;
}): QueryKey;
