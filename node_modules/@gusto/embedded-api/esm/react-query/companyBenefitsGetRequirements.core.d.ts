...
import { GetV1BenefitsBenefitsIdRequirementsHeaderXGustoAPIVersion, GetV1BenefitsBenefitsIdRequirementsRequest, GetV1BenefitsBenefitsIdRequirementsResponse } from "../models/operations/getv1benefitsbenefitsidrequirements.js";
...
export declare function queryKeyCompanyBenefitsGetRequirements(benefitId: string, parameters: {
    xGustoAPIVersion?: GetV1BenefitsBenefitsIdRequirementsHeaderXGustoAPIVersion | undefined;
}): QueryKey;
