...
import { GetV1ContractorsContractorUuidOnboardingStatusHeaderXGustoAPIVersion, GetV1ContractorsContractorUuidOnboardingStatusRequest } from "../models/operations/getv1contractorscontractoruuidonboardingstatus.js";
...
export type ContractorsGetOnboardingStatusQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setContractorsGetOnboardingStatusData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1ContractorsContractorUuidOnboardingStatusHeaderXGustoAPIVersion | undefined;
    }
