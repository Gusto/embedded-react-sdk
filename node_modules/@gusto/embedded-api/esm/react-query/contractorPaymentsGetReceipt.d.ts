...
import { GetV1ContractorPaymentsContractorPaymentUuidReceiptHeaderXGustoAPIVersion, GetV1ContractorPaymentsContractorPaymentUuidReceiptRequest } from "../models/operations/getv1contractorpaymentscontractorpaymentuuidreceipt.js";
...
export type ContractorPaymentsGetReceiptQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setContractorPaymentsGetReceiptData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1ContractorPaymentsContractorPaymentUuidReceiptHeaderXGustoAPIVersion | undefined;
    }
