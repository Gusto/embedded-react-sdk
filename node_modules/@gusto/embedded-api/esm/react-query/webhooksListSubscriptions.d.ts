...
import { GetV1WebhookSubscriptionsHeaderXGustoAPIVersion, GetV1WebhookSubscriptionsRequest, GetV1WebhookSubscriptionsSecurity } from "../models/operations/getv1webhooksubscriptions.js";
...
export declare function setWebhooksListSubscriptionsData(client: QueryClient, queryKeyBase: [
    parameters: {
        xGustoAPIVersion?: GetV1WebhookSubscriptionsHeaderXGustoAPIVersion | undefined;
    }
