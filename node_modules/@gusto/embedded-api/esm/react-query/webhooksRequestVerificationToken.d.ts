...
import { GetV1WebhookSubscriptionVerificationTokenUuidHeaderXGustoAPIVersion, GetV1WebhookSubscriptionVerificationTokenUuidRequest, GetV1WebhookSubscriptionVerificationTokenUuidSecurity } from "../models/operations/getv1webhooksubscriptionverificationtokenuuid.js";
...
export type WebhooksRequestVerificationTokenQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setWebhooksRequestVerificationTokenData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1WebhookSubscriptionVerificationTokenUuidHeaderXGustoAPIVersion | undefined;
    }
