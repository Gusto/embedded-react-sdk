...
import { GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion, GetV1EmployeesEmployeeIdJobsQueryParamInclude, GetV1EmployeesEmployeeIdJobsRequest } from "../models/operations/getv1employeesemployeeidjobs.js";
...
export type JobsAndCompensationsGetJobsQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setJobsAndCompensationsGetJobsData(client: QueryClient, queryKeyBase: [
    employeeId: string,
    parameters: {
        xGustoAPIVersion?: GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion | undefined;
