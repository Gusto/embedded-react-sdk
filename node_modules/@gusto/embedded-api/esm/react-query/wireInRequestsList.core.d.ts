...
import { GetCompaniesCompanyUuidWireInRequestUuidHeaderXGustoAPIVersion, GetCompaniesCompanyUuidWireInRequestUuidRequest, GetCompaniesCompanyUuidWireInRequestUuidResponse } from "../models/operations/getcompaniescompanyuuidwireinrequestuuid.js";
...
export declare function queryKeyWireInRequestsList(companyUuid: string, parameters: {
    xGustoAPIVersion?: GetCompaniesCompanyUuidWireInRequestUuidHeaderXGustoAPIVersion | undefined;
