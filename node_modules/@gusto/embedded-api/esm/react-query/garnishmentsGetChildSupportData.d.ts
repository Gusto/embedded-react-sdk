...
import { GetV1GarnishmentsChildSupportHeaderXGustoAPIVersion, GetV1GarnishmentsChildSupportRequest } from "../models/operations/getv1garnishmentschildsupport.js";
...
export declare function setGarnishmentsGetChildSupportDataData(client: QueryClient, queryKeyBase: [
    parameters: {
        xGustoAPIVersion?: GetV1GarnishmentsChildSupportHeaderXGustoAPIVersion | undefined;
    }
