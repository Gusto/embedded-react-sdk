...
import { GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessHeaderXGustoAPIVersion, GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessRequest } from "../models/operations/getv1partnermanagedcompaniescompanyuuidmigrationreadiness.js";
...
export type CompaniesGetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setCompaniesGetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessData(client: QueryClient, queryKeyBase: [
    companyUuid: string,
    parameters: {
        xGustoAPIVersion?: GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessHeaderXGustoAPIVersion | undefined;
    }
