...
import { GetV1BenefitsCompanyBenefitIdSummaryHeaderXGustoAPIVersion, GetV1BenefitsCompanyBenefitIdSummaryRequest } from "../models/operations/getv1benefitscompanybenefitidsummary.js";
...
export type CompanyBenefitsGetSummaryQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setCompanyBenefitsGetSummaryData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1BenefitsCompanyBenefitIdSummaryHeaderXGustoAPIVersion | undefined;
