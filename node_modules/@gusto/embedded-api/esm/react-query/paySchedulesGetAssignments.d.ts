...
import { GetV1CompaniesCompanyIdPaySchedulesAssignmentsHeaderXGustoAPIVersion, GetV1CompaniesCompanyIdPaySchedulesAssignmentsRequest } from "../models/operations/getv1companiescompanyidpayschedulesassignments.js";
...
export type PaySchedulesGetAssignmentsQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setPaySchedulesGetAssignmentsData(client: QueryClient, queryKeyBase: [
    companyId: string,
    parameters: {
        xGustoAPIVersion?: GetV1CompaniesCompanyIdPaySchedulesAssignmentsHeaderXGustoAPIVersion | undefined;
    }
