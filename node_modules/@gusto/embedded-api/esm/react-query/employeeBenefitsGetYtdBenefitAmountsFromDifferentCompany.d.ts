...
import { GetEmployeeYtdBenefitAmountsFromDifferentCompanyHeaderXGustoAPIVersion, GetEmployeeYtdBenefitAmountsFromDifferentCompanyRequest } from "../models/operations/getemployeeytdbenefitamountsfromdifferentcompany.js";
...
export type EmployeeBenefitsGetYtdBenefitAmountsFromDifferentCompanyQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setEmployeeBenefitsGetYtdBenefitAmountsFromDifferentCompanyData(client: QueryClient, queryKeyBase: [
    employeeId: string,
    parameters: {
        xGustoAPIVersion?: GetEmployeeYtdBenefitAmountsFromDifferentCompanyHeaderXGustoAPIVersion | undefined;
