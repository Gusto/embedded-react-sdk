...
import { GetV1ContractorsContractorUuidBankAccountsHeaderXGustoAPIVersion, GetV1ContractorsContractorUuidBankAccountsRequest } from "../models/operations/getv1contractorscontractoruuidbankaccounts.js";
...
export type ContractorPaymentMethodGetBankAccountsQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setContractorPaymentMethodGetBankAccountsData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1ContractorsContractorUuidBankAccountsHeaderXGustoAPIVersion | undefined;
    }
