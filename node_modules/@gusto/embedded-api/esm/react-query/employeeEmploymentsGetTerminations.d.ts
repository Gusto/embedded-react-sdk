...
import { GetV1EmployeesEmployeeIdTerminationsHeaderXGustoAPIVersion, GetV1EmployeesEmployeeIdTerminationsRequest } from "../models/operations/getv1employeesemployeeidterminations.js";
...
export type EmployeeEmploymentsGetTerminationsQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setEmployeeEmploymentsGetTerminationsData(client: QueryClient, queryKeyBase: [
    employeeId: string,
    parameters: {
        xGustoAPIVersion?: GetV1EmployeesEmployeeIdTerminationsHeaderXGustoAPIVersion | undefined;
    }
