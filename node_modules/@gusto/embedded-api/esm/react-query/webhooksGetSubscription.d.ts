...
import { GetV1WebhookSubscriptionUuidHeaderXGustoAPIVersion, GetV1WebhookSubscriptionUuidRequest, GetV1WebhookSubscriptionUuidSecurity } from "../models/operations/getv1webhooksubscriptionuuid.js";
...
export type WebhooksGetSubscriptionQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setWebhooksGetSubscriptionData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1WebhookSubscriptionUuidHeaderXGustoAPIVersion | undefined;
    }
