...
import { GetV1ContractorsContractorUuidPaymentMethodHeaderXGustoAPIVersion, GetV1ContractorsContractorUuidPaymentMethodRequest } from "../models/operations/getv1contractorscontractoruuidpaymentmethod.js";
...
export type ContractorPaymentMethodGetQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setContractorPaymentMethodGetData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1ContractorsContractorUuidPaymentMethodHeaderXGustoAPIVersion | undefined;
    }
