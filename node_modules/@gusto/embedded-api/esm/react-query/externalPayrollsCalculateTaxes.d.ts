...
import { GetV1ExternalPayrollCalculateTaxesHeaderXGustoAPIVersion, GetV1ExternalPayrollCalculateTaxesRequest } from "../models/operations/getv1externalpayrollcalculatetaxes.js";
...
export type ExternalPayrollsCalculateTaxesQueryError = NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setExternalPayrollsCalculateTaxesData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1ExternalPayrollCalculateTaxesHeaderXGustoAPIVersion | undefined;
    }
