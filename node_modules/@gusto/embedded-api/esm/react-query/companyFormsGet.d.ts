...
import { GetV1CompanyFormHeaderXGustoAPIVersion, GetV1CompanyFormRequest } from "../models/operations/getv1companyform.js";
...
export type CompanyFormsGetQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * Get a company form
 *
 * @remarks
