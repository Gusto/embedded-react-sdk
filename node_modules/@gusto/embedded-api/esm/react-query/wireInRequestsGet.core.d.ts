...
import { GetWireInRequestsWireInRequestUuidHeaderXGustoAPIVersion, GetWireInRequestsWireInRequestUuidRequest, GetWireInRequestsWireInRequestUuidResponse } from "../models/operations/getwireinrequestswireinrequestuuid.js";
...
export declare function queryKeyWireInRequestsGet(wireInRequestUuid: string, parameters: {
    xGustoAPIVersion?: GetWireInRequestsWireInRequestUuidHeaderXGustoAPIVersion | undefined;
}): QueryKey;
