...
import { GetV1CompaniesCompanyIdCustomFieldsHeaderXGustoAPIVersion, GetV1CompaniesCompanyIdCustomFieldsRequest } from "../models/operations/getv1companiescompanyidcustomfields.js";
...
export type CompaniesGetCustomFieldsQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setCompaniesGetCustomFieldsData(client: QueryClient, queryKeyBase: [
    companyId: string,
    parameters: {
        xGustoAPIVersion?: GetV1CompaniesCompanyIdCustomFieldsHeaderXGustoAPIVersion | undefined;
