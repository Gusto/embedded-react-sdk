 ...
 */
export function usePayrollCancellationsPostV1PayrollBatchesMutation(options) {
...
export function mutationKeyPayrollCancellationsPostV1PayrollBatches() {
    return [
...
export function buildPayrollCancellationsPostV1PayrollBatchesMutation(client$, hookOptions) {
    return {
        mutationKey: mutationKeyPayrollCancellationsPostV1PayrollBatches(),
        mutationFn: function payrollCancellationsPostV1PayrollBatchesMutationFn({ security, request, options, }) {
            const mergedOptions = {
                ...hookOptions,
                ...options,
                fetchOptions: {
            ...
            return unwrapAsync(payrollCancellationsPostV1PayrollBatches(client$, security, request, mergedOptions));
        },
    };
}
