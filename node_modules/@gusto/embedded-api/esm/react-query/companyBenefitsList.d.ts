...
import { GetV1CompaniesCompanyIdCompanyBenefitsHeaderXGustoAPIVersion, GetV1CompaniesCompanyIdCompanyBenefitsRequest } from "../models/operations/getv1companiescompanyidcompanybenefits.js";
...
export type CompanyBenefitsListQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setCompanyBenefitsListData(client: QueryClient, queryKeyBase: [
    companyId: string,
    parameters: {
        xGustoAPIVersion?: GetV1CompaniesCompanyIdCompanyBenefitsHeaderXGustoAPIVersion | undefined;
