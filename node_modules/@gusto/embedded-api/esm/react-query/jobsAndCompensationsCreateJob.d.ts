...
import { PostV1EmployeesEmployeeIdJobsRequest, PostV1EmployeesEmployeeIdJobsResponse } from "../models/operations/postv1employeesemployeeidjobs.js";
import { MutationHookOptions } from "./_types.js";
export type JobsAndCompensationsCreateJobMutationVariables = {
    request: PostV1EmployeesEmployeeIdJobsRequest;
    options?: RequestOptions;
};
export type JobsAndCompensationsCreateJobMutationData = PostV1EmployeesEmployeeIdJobsResponse;
export type JobsAndCompensationsCreateJobMutationError = NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * Create a job
 *
 * @remarks
