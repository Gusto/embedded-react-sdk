...
import { GetV1CompaniesAttachmentsHeaderXGustoAPIVersion, GetV1CompaniesAttachmentsRequest, GetV1CompaniesAttachmentsResponse } from "../models/operations/getv1companiesattachments.js";
...
export declare function queryKeyCompanyAttachmentsGetList(companyId: string, parameters: {
    xGustoAPIVersion?: GetV1CompaniesAttachmentsHeaderXGustoAPIVersion | undefined;
}): QueryKey;
