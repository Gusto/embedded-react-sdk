...
import { GetV1GarnishmentsGarnishmentIdHeaderXGustoAPIVersion, GetV1GarnishmentsGarnishmentIdRequest } from "../models/operations/getv1garnishmentsgarnishmentid.js";
...
export type GarnishmentsGetQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * Get a garnishment
 *
 * @remarks
...
export declare function setGarnishmentsGetData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1GarnishmentsGarnishmentIdHeaderXGustoAPIVersion | undefined;
    }
