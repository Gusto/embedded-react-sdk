...
import { GetV1EmployeesEmployeeIdGarnishmentsHeaderXGustoAPIVersion, GetV1EmployeesEmployeeIdGarnishmentsRequest } from "../models/operations/getv1employeesemployeeidgarnishments.js";
...
export type GarnishmentsListQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setGarnishmentsListData(client: QueryClient, queryKeyBase: [
    employeeId: string,
    parameters: {
        xGustoAPIVersion?: GetV1EmployeesEmployeeIdGarnishmentsHeaderXGustoAPIVersion | undefined;
