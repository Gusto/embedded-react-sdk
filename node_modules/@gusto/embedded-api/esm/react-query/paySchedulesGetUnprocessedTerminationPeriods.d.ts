...
import { GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsHeaderXGustoAPIVersion, GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsRequest } from "../models/operations/getv1companiescompanyidunprocessedterminationpayperiods.js";
...
export type PaySchedulesGetUnprocessedTerminationPeriodsQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setPaySchedulesGetUnprocessedTerminationPeriodsData(client: QueryClient, queryKeyBase: [
    companyId: string,
    parameters: {
        xGustoAPIVersion?: GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsHeaderXGustoAPIVersion | undefined;
    }
