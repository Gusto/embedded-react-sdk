...
import { GetV1ContractorsContractorUuidAddressHeaderXGustoAPIVersion, GetV1ContractorsContractorUuidAddressRequest } from "../models/operations/getv1contractorscontractoruuidaddress.js";
...
export type ContractorsGetAddressQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setContractorsGetAddressData(client: QueryClient, queryKeyBase: [
    ...
    parameters: {
        xGustoAPIVersion?: GetV1ContractorsContractorUuidAddressHeaderXGustoAPIVersion | undefined;
    }
