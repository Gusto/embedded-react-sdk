...
import { GetV1JobsJobIdHeaderXGustoAPIVersion, GetV1JobsJobIdQueryParamInclude, GetV1JobsJobIdRequest } from "../models/operations/getv1jobsjobid.js";
...
export type JobsAndCompensationsGetJobQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * Get a job
 *
 * @remarks
