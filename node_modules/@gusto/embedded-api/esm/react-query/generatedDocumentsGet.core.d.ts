...
import { DocumentType, GetV1GeneratedDocumentsDocumentTypeRequestUuidHeaderXGustoAPIVersion, GetV1GeneratedDocumentsDocumentTypeRequestUuidRequest, GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse } from "../models/operations/getv1generateddocumentsdocumenttyperequestuuid.js";
...
export declare function queryKeyGeneratedDocumentsGet(documentType: DocumentType, requestUuid: string, parameters: {
    xGustoAPIVersion?: GetV1GeneratedDocumentsDocumentTypeRequestUuidHeaderXGustoAPIVersion | undefined;
}): QueryKey;
