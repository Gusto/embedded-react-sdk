...
import { GetV1ContractorDocumentPdfHeaderXGustoAPIVersion, GetV1ContractorDocumentPdfRequest } from "../models/operations/getv1contractordocumentpdf.js";
...
export type ContractorDocumentsGetPdfQueryError = NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
...
export declare function setContractorDocumentsGetPdfData(client: QueryClient, queryKeyBase: [
    documentUuid: string,
    parameters: {
        xGustoAPIVersion?: GetV1ContractorDocumentPdfHeaderXGustoAPIVersion | undefined;
    }
