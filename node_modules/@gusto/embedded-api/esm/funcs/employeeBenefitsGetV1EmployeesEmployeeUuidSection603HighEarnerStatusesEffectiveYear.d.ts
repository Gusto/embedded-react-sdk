 ...
 */
export declare function employeeBenefitsGetV1EmployeesEmployeeUuidSection603HighEarnerStatusesEffectiveYear(client: GustoEmbeddedCore, request: GetV1EmployeesEmployeeUuidSection603HighEarnerStatusesEffectiveYearRequest, options?: RequestOptions): APIPromise<Result<GetV1EmployeesEmployeeUuidSection603HighEarnerStatusesEffectiveYearResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
