 ...
 */
export declare function paymentConfigsUpdate(client: GustoEmbeddedCore, request: PutV1CompanyPaymentConfigsRequest, options?: RequestOptions): APIPromise<Result<PutV1CompanyPaymentConfigsResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
