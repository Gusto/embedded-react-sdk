 ...
 */
export declare function employeeFormsSign(client: GustoEmbeddedCore, request: PutV1EmployeeFormSignRequest, options?: RequestOptions): APIPromise<Result<PutV1EmployeeFormSignResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
