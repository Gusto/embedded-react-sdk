 ...
 */
export declare function reportsCreateCustom(client: GustoEmbeddedCore, request: PostCompaniesCompanyUuidReportsRequest, options?: RequestOptions): APIPromise<Result<PostCompaniesCompanyUuidReportsResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
