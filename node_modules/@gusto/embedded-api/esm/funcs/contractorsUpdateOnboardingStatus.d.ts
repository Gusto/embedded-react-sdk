 ...
 */
export declare function contractorsUpdateOnboardingStatus(client: GustoEmbeddedCore, request: PutV1ContractorsContractorUuidOnboardingStatusRequest, options?: RequestOptions): APIPromise<Result<PutV1ContractorsContractorUuidOnboardingStatusResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
