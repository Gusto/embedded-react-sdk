 ...
 */
export declare function flowsCreate(client: GustoEmbeddedCore, request: PostV1CompanyFlowsRequest, options?: RequestOptions): APIPromise<Result<PostV1CompanyFlowsResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
