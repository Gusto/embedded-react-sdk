 ...
 */
export declare function employeesDelete(client: GustoEmbeddedCore, request: DeleteV1EmployeeRequest, options?: RequestOptions): APIPromise<Result<DeleteV1EmployeeResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
