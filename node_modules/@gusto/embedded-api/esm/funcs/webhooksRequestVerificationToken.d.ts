 ...
 */
export declare function webhooksRequestVerificationToken(client: GustoEmbeddedCore, security: GetV1WebhookSubscriptionVerificationTokenUuidSecurity, request: GetV1WebhookSubscriptionVerificationTokenUuidRequest, options?: RequestOptions): APIPromise<Result<GetV1WebhookSubscriptionVerificationTokenUuidResponse, NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
