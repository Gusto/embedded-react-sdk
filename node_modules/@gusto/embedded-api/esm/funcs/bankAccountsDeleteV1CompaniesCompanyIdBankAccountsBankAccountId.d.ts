 ...
 */
export declare function bankAccountsDeleteV1CompaniesCompanyIdBankAccountsBankAccountId(client: GustoEmbeddedCore, request: DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest, options?: RequestOptions): APIPromise<Result<DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
