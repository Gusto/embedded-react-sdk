 ...
 */
export declare function payrollsCalculate(client: GustoEmbeddedCore, request: PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest, options?: RequestOptions): APIPromise<Result<PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
