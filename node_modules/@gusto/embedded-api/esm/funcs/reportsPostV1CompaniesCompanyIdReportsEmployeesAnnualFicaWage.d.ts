 ...
 */
export declare function reportsPostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage(client: GustoEmbeddedCore, request: PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest, options?: RequestOptions): APIPromise<Result<PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
