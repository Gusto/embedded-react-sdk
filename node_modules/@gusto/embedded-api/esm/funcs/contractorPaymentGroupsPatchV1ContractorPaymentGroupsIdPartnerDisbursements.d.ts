 ...
 */
export declare function contractorPaymentGroupsPatchV1ContractorPaymentGroupsIdPartnerDisbursements(client: GustoEmbeddedCore, request: PatchV1ContractorPaymentGroupsIdPartnerDisbursementsRequest, options?: RequestOptions): APIPromise<Result<PatchV1ContractorPaymentGroupsIdPartnerDisbursementsResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
