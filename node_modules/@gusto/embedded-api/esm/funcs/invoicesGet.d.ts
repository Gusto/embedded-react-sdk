 ...
 * scope: `invoices:read`
 */
export declare function invoicesGet(client: GustoEmbeddedCore, security: GetInvoicesInvoicePeriodSecurity, request: GetInvoicesInvoicePeriodRequest, options?: RequestOptions): APIPromise<Result<GetInvoicesInvoicePeriodResponse, UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
