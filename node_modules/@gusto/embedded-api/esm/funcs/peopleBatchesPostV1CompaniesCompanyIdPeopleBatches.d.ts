 ...
 */
export declare function peopleBatchesPostV1CompaniesCompanyIdPeopleBatches(client: GustoEmbeddedCore, request: PostV1CompaniesCompanyIdPeopleBatchesRequest, options?: RequestOptions): APIPromise<Result<PostV1CompaniesCompanyIdPeopleBatchesResponse, NotFoundErrorObject | PeopleBatchConflictError | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
