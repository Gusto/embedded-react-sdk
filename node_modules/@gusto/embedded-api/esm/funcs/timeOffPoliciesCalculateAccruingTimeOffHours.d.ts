 ...
 */
export declare function timeOffPoliciesCalculateAccruingTimeOffHours(client: GustoEmbeddedCore, request: PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursRequest, options?: RequestOptions): APIPromise<Result<PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
