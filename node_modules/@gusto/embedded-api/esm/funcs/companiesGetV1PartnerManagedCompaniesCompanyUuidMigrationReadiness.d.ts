 ...
 */
export declare function companiesGetV1PartnerManagedCompaniesCompanyUuidMigrationReadiness(client: GustoEmbeddedCore, request: GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessRequest, options?: RequestOptions): APIPromise<Result<GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessResponse, NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
