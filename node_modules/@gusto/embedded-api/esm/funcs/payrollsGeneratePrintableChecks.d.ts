 ...
 */
export declare function payrollsGeneratePrintableChecks(client: GustoEmbeddedCore, request: PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequest, options?: RequestOptions): APIPromise<Result<PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
