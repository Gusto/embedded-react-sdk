 ...
 */
export declare function informationRequestsSubmit(client: GustoEmbeddedCore, request: SubmitInformationRequestRequest, options?: RequestOptions): APIPromise<Result<SubmitInformationRequestResponse, UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
