 ...
 */
export declare function payrollsCalculateGrossUp(client: GustoEmbeddedCore, request: PostPayrollsGrossUpPayrollUuidRequest, options?: RequestOptions): APIPromise<Result<PostPayrollsGrossUpPayrollUuidResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
