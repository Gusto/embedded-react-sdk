 ...
 */
export declare function payrollsSkip(client: GustoEmbeddedCore, request: PostCompaniesPayrollSkipCompanyUuidRequest, options?: RequestOptions): APIPromise<Result<PostCompaniesPayrollSkipCompanyUuidResponse, NotFoundErrorObject | PayrollBlockersError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
