 ...
 */
export declare function payrollsCreateOffCycle(client: GustoEmbeddedCore, request: PostV1CompaniesCompanyIdPayrollsRequest, options?: RequestOptions): APIPromise<Result<PostV1CompaniesCompanyIdPayrollsResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
