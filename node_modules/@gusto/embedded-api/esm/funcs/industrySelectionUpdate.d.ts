 ...
 */
export declare function industrySelectionUpdate(client: GustoEmbeddedCore, request: PutV1CompanyIndustryRequest, options?: RequestOptions): APIPromise<Result<PutV1CompanyIndustryResponse, NotFoundErrorObject | UnprocessableEntityError | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
