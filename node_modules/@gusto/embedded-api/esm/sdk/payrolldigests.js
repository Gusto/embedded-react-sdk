...
export class PayrollDigests extends ClientSDK {
     ...
     */
    async postV1PayrollDigests(security, request, options) {
        return unwrapAsync(payrollDigestsPostV1PayrollDigests(this, security, request, options));
    }
    /**
     ...
     */
    async getV1PayrollDigestsPayrollDigestUuid(security, request, options) {
        return unwrapAsync(payrollDigestsGetV1PayrollDigestsPayrollDigestUuid(this, security, request, options));
    }
}
//# sourceMappingURL=payrolldigests.js.map