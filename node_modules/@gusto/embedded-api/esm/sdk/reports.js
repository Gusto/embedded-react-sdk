...
export class Reports extends ClientSDK {
     ...
     */
    async postV1BulkReports(security, request, options) {
        return unwrapAsync(reportsPostV1BulkReports(this, security, request, options));
    }
    /**
     ...
     */
    async getV1BulkReportsRequestUuid(security, request, options) {
        return unwrapAsync(reportsGetV1BulkReportsRequestUuid(this, security, request, options));
    }
    /**
