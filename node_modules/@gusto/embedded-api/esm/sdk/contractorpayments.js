...
export class ContractorPayments extends ClientSDK {
     ...
     */
    async getV1ContractorsContractorUuidPayments(request, options) {
        return unwrapAsync(contractorPaymentsGetV1ContractorsContractorUuidPayments(this, request, options));
    }
    /**
     ...
     * scope: `payrolls:read`
     */
    async getV1ContractorPaymentsContractorPaymentIdPdf(request, options) {
        return unwrapAsync(contractorPaymentsGetV1ContractorPaymentsContractorPaymentIdPdf(this, request, options));
    }
    /**
