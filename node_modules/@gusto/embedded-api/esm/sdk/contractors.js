...
export class Contractors extends ClientSDK {
     ...
     * scope: `contractors:write`
     */
    async postV1ContractorsContractorUuidRehire(request, options) {
        return unwrapAsync(contractorsPostV1ContractorsContractorUuidRehire(this, request, options));
    }
    /**
     ...
     * scope: `contractors:write`
     */
    async deleteV1ContractorsContractorUuidRehire(request, options) {
        return unwrapAsync(contractorsDeleteV1ContractorsContractorUuidRehire(this, request, options));
    }
    /**
     ...
     * scope: `contractors:write`
     */
    async postV1ContractorsContractorUuidTermination(request, options) {
        return unwrapAsync(contractorsPostV1ContractorsContractorUuidTermination(this, request, options));
    }
    /**
     ...
     * scope: `contractors:write`
     */
    async deleteV1ContractorsContractorUuidTermination(request, options) {
