...
import { DeleteV1ContractorsContractorUuidRehireRequest, DeleteV1ContractorsContractorUuidRehireResponse } from "../models/operations/deletev1contractorscontractoruuidrehire.js";
import { DeleteV1ContractorsContractorUuidTerminationRequest, DeleteV1ContractorsContractorUuidTerminationResponse } from "../models/operations/deletev1contractorscontractoruuidtermination.js";
...
import { PostV1ContractorsContractorUuidRehireRequest, PostV1ContractorsContractorUuidRehireResponse } from "../models/operations/postv1contractorscontractoruuidrehire.js";
import { PostV1ContractorsContractorUuidTerminationRequest, PostV1ContractorsContractorUuidTerminationResponse } from "../models/operations/postv1contractorscontractoruuidtermination.js";
...
export declare class Contractors extends ClientSDK {
     ...
     * scope: `contractors:write`
     */
    postV1ContractorsContractorUuidRehire(request: PostV1ContractorsContractorUuidRehireRequest, options?: RequestOptions): Promise<PostV1ContractorsContractorUuidRehireResponse>;
    /**
     ...
     * scope: `contractors:write`
     */
    deleteV1ContractorsContractorUuidRehire(request: DeleteV1ContractorsContractorUuidRehireRequest, options?: RequestOptions): Promise<DeleteV1ContractorsContractorUuidRehireResponse>;
    /**
     ...
     * scope: `contractors:write`
     */
    postV1ContractorsContractorUuidTermination(request: PostV1ContractorsContractorUuidTerminationRequest, options?: RequestOptions): Promise<PostV1ContractorsContractorUuidTerminationResponse>;
    /**
     ...
     * scope: `contractors:write`
     */
    deleteV1ContractorsContractorUuidTermination(request: DeleteV1ContractorsContractorUuidTerminationRequest, options?: RequestOptions): Promise<DeleteV1ContractorsContractorUuidTerminationResponse>;
    /**
     * Get a contractor
     *
     * @remarks
