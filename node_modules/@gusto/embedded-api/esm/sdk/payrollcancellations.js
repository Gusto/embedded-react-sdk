...
export class PayrollCancellations extends ClientSDK {
     ...
     */
    async postV1PayrollBatches(security, request, options) {
        return unwrapAsync(payrollCancellationsPostV1PayrollBatches(this, security, request, options));
    }
    /**
     ...
     */
    async getV1PayrollBatchesPayrollBatchUuid(security, request, options) {
        return unwrapAsync(payrollCancellationsGetV1PayrollBatchesPayrollBatchUuid(this, security, request, options));
    }
}
//# sourceMappingURL=payrollcancellations.js.map