...
export class ReverseWireTransactions extends ClientSDK {
     ...
     */
    async getReverseWireTransactions(request, options) {
        return unwrapAsync(reverseWireTransactionsGetReverseWireTransactions(this, request, options));
    }
}
//# sourceMappingURL=reversewiretransactions.js.map