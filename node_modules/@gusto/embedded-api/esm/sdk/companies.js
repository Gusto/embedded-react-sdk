...
export class Companies extends ClientSDK {
     ...
     */
    async putV1PartnerManagedCompaniesCompanyUuidDisassociate(security, request, options) {
        return unwrapAsync(companiesPutV1PartnerManagedCompaniesCompanyUuidDisassociate(this, security, request, options));
    }
    /**
     ...
     * scope: `terms_of_services:read`
     */
    async getV1PartnerManagedCompaniesCompanyUuidTermsOfService(request, options) {
        return unwrapAsync(companiesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService(this, request, options));
    }
    /**
     ...
     * scope: `terms_of_services:read`
     */
    async putV1PartnerManagedCompaniesCompanyUuidTermsOfService(request, options) {
        return unwrapAsync(companiesPutV1PartnerManagedCompaniesCompanyUuidTermsOfService(this, request, options));
    }
    /**
     ...
     * scope: `terms_of_services:write`
     */
    async postV1PartnerManagedCompaniesCompanyUuidTermsOfService(request, options) {
        return unwrapAsync(companiesPostV1PartnerManagedCompaniesCompanyUuidTermsOfService(this, request, options));
    }
}
