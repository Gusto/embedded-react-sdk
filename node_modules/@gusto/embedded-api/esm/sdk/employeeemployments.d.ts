...
import { GetV1TerminationsEmployeeIdRequest, GetV1TerminationsEmployeeIdResponse } from "../models/operations/getv1terminationsemployeeid.js";
...
export declare class EmployeeEmployments extends ClientSDK {
     ...
     * scope: `employments:read`
     */
    getV1TerminationsEmployeeId(request: GetV1TerminationsEmployeeIdRequest, options?: RequestOptions): Promise<GetV1TerminationsEmployeeIdResponse>;
}
