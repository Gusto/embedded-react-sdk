...
function justName(filename = '') {
    ...
    if (hashIndex !== -1) {
        return (0, path_1.basename)(filename.slice(hashIndex + 1));
    }
 ...
 */
const JS_YAML_4_SCHEMA = js_yaml_1.CORE_SCHEMA.withTags(js_yaml_1.mergeTag, js_yaml_1.timestampTag, js_yaml_1.binaryTag, js_yaml_1.omapTag, js_yaml_1.pairsTag, js_yaml_1.setTag);
function parseFileAsJSONSchema(filename, contents) {
    if (filename != null && isYaml(filename)) {
        return Try(() => (0, js_yaml_1.load)(contents.toString(), { schema: JS_YAML_4_SCHEMA }), () => {
