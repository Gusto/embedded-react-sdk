...
const defaultOptions = (0, lodash_1.omit)(index_1.DEFAULT_OPTIONS, 'cwd');
...
function processFile(argIn, argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cwd = filename ? (0, path_1.dirname)((0, path_1.resolve)(process.cwd(), filename)) : undefined;
        return (0, index_1.compile)(schema, argIn, cwd ? Object.assign({ cwd }, argv) : argv);
    });
}
