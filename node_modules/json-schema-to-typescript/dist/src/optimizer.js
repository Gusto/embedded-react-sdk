        ...
        case 'UNION':
            ...
            if (optimizedAST.type === 'INTERSECTION') {
                ...
                if (constrained.length > 0 && constrained.length < optimizedAST.params.length) {
                    (0, utils_1.log)('cyan', 'optimizer', '[A & B & Unknown] -> [A & B]', optimizedAST);
            ...
            if (optimizedAST.params.every(_ => {
                const a = (0, generator_1.generateType)((0, AST_1.omitStandaloneName)(_), options);
                const b = (0, generator_1.generateType)((0, AST_1.omitStandaloneName)(optimizedAST.params[0]), options);
                return a === b;
            }) &&
