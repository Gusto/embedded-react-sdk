...
function compile(schema_1, name_1) {
    return __awaiter(this, arguments, void 0, function* (schema, name, options = {}) {
        ...
        (0, normalizer_1.normalizeNullableRefs)(_schema);
        ...
        const parsed = (0, parser_1.parse)(normalized, _options, undefined, processed, usedNames);
        (0, parser_1.nameAnonymousRecursiveTypes)(parsed, processed, dereferencedPaths, usedNames);
