...
function tryGetPackageInfo(name) {
  if (process.versions.pnp) {
    const targetRequire = require$$0.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('shared/unplugin-dts.D13_aqpS.cjs', document.baseURI).href)));
    try {
