...
var import_bezier_easing = __toESM(require("bezier-easing"), 1);
...
function getEasingFunctionFromString(easing) {
  ...
  if (easing.indexOf("cubic-bezier(") === 0) {
    ...
    easingFunctions[easing] = (0, import_bezier_easing.default)(
      bezierArray[0],
      bezierArray[1],
      bezierArray[2],
      bezierArray[3]
