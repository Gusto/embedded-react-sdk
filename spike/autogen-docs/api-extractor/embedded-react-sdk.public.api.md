## Public API Report File for "@gusto/embedded-react-sdk"
...
export function CheckboxHookField<TErrorCode extends string>(
  input: CheckboxHookFieldProps<TErrorCode>,
...
// @public (undocumented)
export type ChildSupportGarnishmentAmountValidation =
...
// @public (undocumented)
export type ChildSupportGarnishmentNegativeAmountValidation =
...
// @public (undocumented)
export type ChildSupportGarnishmentRequiredValidation =
...
// @public (undocumented)
export type CompensationEffectiveDateValidation = (typeof CompensationErrorCodes)[
  | 'REQUIRED'
...
export function createChildSupportGarnishmentFormSchema(
  input?: ChildSupportGarnishmentFormSchemaOptions,
...
// @public (undocumented)
export function createCompensationSchema(
...
//
// @public (undocumented)
export function createDeductionFormSchema(
...
//
// @public (undocumented)
export function createEmployeeDetailsSchema(
...
//
// @public (undocumented)
export function createFederalTaxesSchema(
...
//
// @public (undocumented)
export function createPaymentMethodFormSchema(
...
//
// @public (undocumented)
export function createSignCompanyFormSchema(
...
//
// @public (undocumented)
export function createSignEmployeeFormSchema(
...
//
// @public (undocumented)
export function createSplitPaymentsFormSchema(
...
export function DatePickerHookField<TErrorCode extends string>(
  input: DatePickerHookFieldProps<TErrorCode>,
): ReactElement<unknown, string | JSXElementConstructor<any>>
...
// @public (undocumented)
function FederalTaxes_2(
  input: FederalTaxesProps_2 & Pick<BaseComponentInterface, 'FallbackComponent'>,
): JSX_2.Element

// @public (undocumented)
function FederalTaxes_3(
  input: FederalTaxesProps_3 & Pick<BaseComponentInterface, 'FallbackComponent'>,
): JSX_2.Element
...
// @public (undocumented)
export const FILING_STATUS_VALUES: readonly [
  'Single',
  'Married',
  'Head of Household',
...
namespace InformationRequestForm {
  var // (undocumented)
    Footer: (input: { onEvent: OnEventType<EventType, unknown> }) => JSX_2.Element
}
...
//
// @public (undocumented)
function ManagementEmployeeList(
  input: ManagementEmployeeListProps & BaseComponentInterface,
): JSX_2.Element
...
export function NumberInputHookField<TErrorCode extends string>(
  input: NumberInputHookFieldProps<TErrorCode>,
): ReactElement<unknown, string | JSXElementConstructor<any>>
...
// @public (undocumented)
export type PayPeriodMaximumValidation =
  | ChildSupportGarnishmentRequiredValidation
...
// @public (undocumented)
function Profile_2(
  input: ProfileProps_2 & Pick<BaseComponentInterface, 'FallbackComponent'>,
): JSX_2.Element
...
export function RadioGroupHookField<TErrorCode extends string, TEntry = unknown>(
  input: RadioGroupHookFieldProps<TErrorCode, TEntry>,
): ReactElement<unknown, string | JSXElementConstructor<any>>
...
>(input: SDKFormProviderProps<TFormData, TFieldsMetadata>): JSX_2.Element
...
export function SelectHookField<TErrorCode extends string, TEntry = unknown>(
  input: SelectHookFieldProps<TErrorCode, TEntry>,
): ReactElement<unknown, string | JSXElementConstructor<any>>
...
// @public (undocumented)
function StateTaxes_2(
  input: StateTaxesProps_2 & Pick<BaseComponentInterface, 'FallbackComponent'>,
): JSX_2.Element

// @public (undocumented)
function StateTaxes_3(
  input: StateTaxesProps_3 & Pick<BaseComponentInterface, 'FallbackComponent'>,
): JSX_2.Element
...
// @public (undocumented)
export type Street1FieldProps = HookFieldProps<
  TextInputHookFieldProps<HomeAddressRequiredValidation>
>

// @public (undocumented)
export type Street2FieldProps = HookFieldProps<
  TextInputHookFieldProps<HomeAddressRequiredValidation>
>
...
// @public
export const SUPPORTED_REQUIRED_ATTR_KEYS: readonly [
  'case_number',
  'order_number',
  'remittance_number',
]
...
export function SwitchHookField<TErrorCode extends string>(
  input: SwitchHookFieldProps<TErrorCode>,
): ReactElement<unknown, string | JSXElementConstructor<any>>
...
>(
  input: TextInputHookFieldProps<TErrorCode, TOptionalErrorCode>,
): ReactElement<unknown, string | JSXElementConstructor<any>>
...
// @public (undocumented)
export type TotalAmountFieldProps = HookFieldProps<
  NumberInputHookFieldProps<DeductionFormCapValidation>
>
...
export function useChildSupportGarnishmentForm(
  input: UseChildSupportGarnishmentFormProps,
...
export function useCompensationForm(
  input: UseCompensationFormProps,
...
export function useEmployeeStateTaxesForm(
  input: UseEmployeeStateTaxesFormProps,
...
export function useFederalTaxesForm(
  input: UseFederalTaxesFormProps,
...
export function usePaymentMethodForm(
  input: UsePaymentMethodFormProps,
...
export function useSignEmployeeForm(
  input: UseSignEmployeeFormProps,
...
export function useSplitPaymentsForm(
  input: UseSplitPaymentsFormProps,
