const card = { "title": "Federal taxes", "editCta": "Edit", "filingStatus": "Filing status", "multipleJobs": "Multiple jobs", "dependentsAndOtherCredits": "Dependents and other credits", "otherIncome": "Other income", "deductions": "Deductions", "extraWithholding": "Extra withholding", "listEmptyPlaceholder": "No value" };
const common = { "yes": "Yes", "no": "No" };
...
const alerts = { "federalTaxesUpdated": "Federal tax settings successfully updated." };
