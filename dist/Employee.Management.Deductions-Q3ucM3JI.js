const title = "Deductions";
const addDeductionCta = "Add deduction";
const listLabel = "List of deductions";
const columns = { "deduction": "Deduction", "frequency": "Frequency", "withhold": "Withheld" };
const recurring = "Recurring";
const oneTime = "One-time";
const amountPerPaycheck = "{{value}} per paycheck";
const emptyState = { "title": "No deductions", "description": "Employee deductions will appear here" };
