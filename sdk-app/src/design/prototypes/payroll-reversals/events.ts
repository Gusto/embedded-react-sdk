export const payrollReversalEvents = {
  ...
  REVERSAL_BACK_TO_PAYROLL: 'payrollReversal/back/payroll',
  REVERSAL_BACK_TO_EMPLOYEES: 'payrollReversal/back/employees',
  REVERSAL_SUBMIT: 'payrollReversal/submit',
  REVERSAL_CANCEL: 'payrollReversal/cancel',
} as const
