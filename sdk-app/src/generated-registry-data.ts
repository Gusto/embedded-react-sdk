...
export const ENTITY_REQUIREMENTS: Record<string, string[]> = {
  ...
  'Contractor.DocumentSigner': ['contractorId'],
  'Contractor.Landing': ['contractorId', 'companyId'],
  ...
  'Contractor.SelfOnboardingFlow': ['companyId', 'contractorId'],
  'Contractor.SelfOnboardingSummary': ['contractorId'],
  'Employee.Compensation': ['employeeId'],
  'Employee.DashboardFlow': ['employeeId'],
  ...
  'Hooks.CompensationForm': ['companyId'],
  'Hooks.EmployeeDetailsForm': ['companyId'],
  'Hooks.HomeAddressForm': ['employeeId'],
  'Hooks.PayScheduleForm': ['companyId'],
  'Hooks.SignCompanyForm': ['companyId'],
  'Hooks.SignEmployeeForm': ['employeeId'],
  'Hooks.SignEmployeeI9Form': ['employeeId'],
...
export const ADDITIONAL_REQUIRED_PROPS: Record<string, string[]> = {
  ...
  'Hooks.SignCompanyForm': ['formId'],
  'Hooks.SignEmployeeForm': ['formId'],
  'Hooks.SignEmployeeI9Form': ['formId'],
