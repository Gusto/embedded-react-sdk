...
export const ENTITY_REQUIREMENTS: Record<string, string[]> = {
  ...
  'Employee.HomeAddress': ['employeeId'],
  ...
  'Hooks.collectErrors': ['companyId'],
  'Hooks.composeErrorHandler': ['companyId'],
...
export const ADDITIONAL_REQUIRED_PROPS: Record<string, string[]> = {
  ...
  'Hooks.collectErrors': ['length', 'toString', 'toLocaleString', 'pop', 'push', 'concat', 'join', 'reverse', 'shift', 'slice', 'sort', 'splice', 'unshift', 'indexOf', 'lastIndexOf', 'every', 'some', 'forEach', 'map', 'filter', 'reduce', 'reduceRight', 'find', 'findIndex', 'fill', 'copyWithin', 'entries', 'keys', 'values', 'includes', 'flatMap', 'flat', 'at', 'findLast', 'findLastIndex', 'toReversed', 'toSorted', 'toSpliced', 'with', '__@iterator@1123', '__@unscopables@1125'],
  'Hooks.composeErrorHandler': ['length', 'toString', 'toLocaleString', 'pop', 'push', 'concat', 'join', 'reverse', 'shift', 'slice', 'sort', 'splice', 'unshift', 'indexOf', 'lastIndexOf', 'every', 'some', 'forEach', 'map', 'filter', 'reduce', 'reduceRight', 'find', 'findIndex', 'fill', 'copyWithin', 'entries', 'keys', 'values', 'includes', 'flatMap', 'flat', 'at', 'findLast', 'findLastIndex', 'toReversed', 'toSorted', 'toSpliced', 'with', '__@iterator@1123', '__@unscopables@1125'],
