...
export const ENTITY_REQUIREMENTS: Record<string, string[]> = {
  ...
  'ContractorOnboarding.ContractorDocumentSigner': ['contractorId'],
...
export const ADDITIONAL_REQUIRED_PROPS: Record<string, string[]> = {
  ...
  'TimeOff.TimeOffPolicyDetailPresentation': ['title', 'onBack', 'backLabel', 'selectedTabId', 'onTabChange', 'employees', 'removeDialog', 'policyDetails'],
}
