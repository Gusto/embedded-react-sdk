      ...
      >
        ...
        >
          ...
          <p style={{ margin: 0, color: '#6b7280', maxWidth: '60ch' }}>
            Each block of the EmployeeOnboarding flow is also exported as a standalone component.
        ...
        <div style={{ overflowX: 'auto' }}>
          ...
          >
            <ComponentFrame
              name="EmployeeOnboarding.Profile"
            ...
            <ComponentFrame
              name="EmployeeOnboarding.Compensation"
            ...
            <ComponentFrame
              name="EmployeeOnboarding.FederalTaxes"
              description="Federal W-4 withholding details collected from the employee."
            >
              <EmployeeOnboarding.FederalTaxes employeeId={EMPLOYEE_ID} onEvent={logEvent} />
            </ComponentFrame>

            <ComponentFrame
              name="EmployeeOnboarding.StateTaxes"
              description="State tax forms tailored to the employee's home and work locations."
            >
              <EmployeeOnboarding.StateTaxes employeeId={EMPLOYEE_ID} onEvent={logEvent} />
            </ComponentFrame>

            <ComponentFrame
              name="EmployeeOnboarding.PaymentMethod"
            ...
            <ComponentFrame
              name="EmployeeOnboarding.Deductions"
              description="Post-tax garnishments, child support, and custom deductions."
            >
              <EmployeeOnboarding.Deductions employeeId={EMPLOYEE_ID} onEvent={logEvent} />
            </ComponentFrame>

            <ComponentFrame
              name="EmployeeOnboarding.OnboardingSummary"
