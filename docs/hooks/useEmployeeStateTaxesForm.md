...
| `EmployeeStateTaxesList`           | API record for one state's tax answers, re-exported from `@gusto/embedded-api-v-2026-06-15`. Each entry in `data.employeeStateTaxes` is one of these.                                                    |
