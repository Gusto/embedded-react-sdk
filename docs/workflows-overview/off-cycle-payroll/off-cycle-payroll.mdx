  ...
  items={[
    {
      ...
      description: 'Main creation form — reason, pay period dates, employee selection, deductions, and tax withholding.',
    ...
    },
    {
      ...
      description: 'Choose whether to include or skip regular deductions for the off-cycle payroll.',
