  ...
  items={[
    {
      ...
      description: 'List of information requests for a company with status badges and a "Respond" CTA.',
      to: './sub-components#information-requests-list',
    },
    {
      title: 'Information request form',
      description: 'Dynamic response form for a single information request, rendered from the required questions.',
