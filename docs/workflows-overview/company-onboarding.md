...
| COMPANY_SIGN_FORM_DONE                | Fired when a form is successfully signed                         | [Response from the sign company form API request](https://docs.gusto.com/embedded-payroll/reference/put-v1-company-form-sign)                                |
