...
| **Employee.Taxes** | GET | `/v1/employees/:employeeId/federal_taxes` |
|  | PUT | `/v1/employees/:employeeId/federal_taxes` |
|  | GET | `/v1/employees/:employeeId/state_taxes` |
|  | PUT | `/v1/employees/:employeeId/state_taxes` |
...
|  | PUT | `/v1/companies/:companyId/signatories/:signatoryUuid` |
|  | DELETE | `/v1/companies/:companyId/signatories/:signatoryUuid` |
...
|  | GET | `/v1/companies/:companyId/signatories` |
|  | GET | `/v1/forms/:formId` |
...
| **Company.Locations** | PUT | `/v1/locations/:locationUuid` |
|  | GET | `/v1/locations/:locationUuid` |
...
| **Company.StateTaxes** | PUT | `/v1/companies/:companyId/tax_requirements/:state` |
|  | GET | `/v1/companies/:companyId/tax_requirements/:state` |
|  | GET | `/v1/companies/:companyId/tax_requirements` |
...
| **Contractor.Payments.CreatePayment** | GET | `/v1/companies/:companyId/contractors` |
...
| **Contractor.Payments.PaymentHistory** | GET | `/v1/contractor_payment_groups/:paymentGroupId` |
|  | GET | `/v1/companies/:companyId/contractors` |
|  | DELETE | `/v1/companies/:companyId/contractor_payments/:paymentId` |
| **Contractor.Payments.PaymentStatement** | GET | `/v1/contractor_payment_groups/:paymentGroupId` |
|  | GET | `/v1/companies/:companyId/contractors` |
|  | GET | `/v1/contractor_payments/:paymentId/receipt` |
| **Contractor.Payments.PaymentSummary** | GET | `/v1/contractor_payment_groups/:paymentGroupId` |
|  | GET | `/v1/companies/:companyId/contractors` |
|  | GET | `/v1/companies/:companyId/bank_accounts` |
...
| Component | Method | Path |
| --- | --- | --- |
| **Payroll.ConfirmWireDetails** | GET | `/v1/companies/:companyId/wire_in_requests` |
|  | GET | `/v1/companies/:companyId/payrolls` |
|  | PUT | `/v1/wire_in_requests/:wireInRequestId` |
|  | GET | `/v1/wire_in_requests/:wireInRequestId` |
| **Payroll.PayrollBlocker** | GET | `/v1/companies/:companyId/payrolls/blockers` |
...
| **Payroll.PayrollLanding** | GET | `/v1/companies/:companyId/wire_in_requests` |
|  | GET | `/v1/companies/:companyId/payrolls/blockers` |
| **Payroll.PayrollList** | GET | `/v1/companies/:companyId/payrolls` |
|  | GET | `/v1/companies/:companyId/pay_schedules` |
|  | POST | `/v1/companies/:companyId/payrolls/skip` |
|  | GET | `/v1/companies/:companyId/payrolls/blockers` |
|  | GET | `/v1/companies/:companyId/wire_in_requests` |
...
| **Payroll.RecoveryCases** | GET | `/v1/companies/:companyId/recovery_cases` |
|  | PUT | `/v1/recovery_cases/:recoveryCaseId/redebit` |
...
| Component | Method | Path |
| --- | --- | --- |
| **InformationRequests** | GET | `/v1/companies/:companyId/information_requests` |
|  | PUT | `/v1/information_requests/:informationRequestId/submit` |
