...
> **DayValidation** = _typeof_ [`PayScheduleErrorCodes`](#payscheduleerrorcodes)\[`"REQUIRED"` \| `"DAY_RANGE"`\]
...
> **PayScheduleErrorCode** = _typeof_ [`PayScheduleErrorCodes`](#payscheduleerrorcodes)\[keyof _typeof_ [`PayScheduleErrorCodes`](#payscheduleerrorcodes)\]
...
> **PayScheduleField** = keyof _typeof_ `fieldValidators`
...
> **PayScheduleFrequency** = _typeof_ `FREQUENCY_VALUES`\[`number`\]
...
> **PayScheduleOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **PayScheduleRequiredValidation** = _typeof_ `PayScheduleErrorCodes.REQUIRED`
...
> **SignCompanyFormErrorCode** = _typeof_ [`SignCompanyFormErrorCodes`](#signcompanyformerrorcodes)\[keyof _typeof_ [`SignCompanyFormErrorCodes`](#signcompanyformerrorcodes)\]
...
> **SignCompanyFormField** = keyof _typeof_ `fieldValidators`
...
> **SignCompanyFormOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **SignCompanyFormRequiredValidation** = _typeof_ `SignCompanyFormErrorCodes.REQUIRED`
