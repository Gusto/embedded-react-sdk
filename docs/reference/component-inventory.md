...
description: Primitive UI elements that SDK components render internally, and the ComponentsAdapter interface for replacing them with your own design-system components.
sidebar_position: 14
