...
| `defaultValues?` | [`RequireAtLeastOne`](../../components.md#requireatleastone)\<[`OnboardingDefaultValues`](blocks.md#onboardingdefaultvalues)\> | | Default values for individual flow step components. |
