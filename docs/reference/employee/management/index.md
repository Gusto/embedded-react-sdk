...
| [RehireEmployee](blocks.md#rehireemployee) | Standalone form for scheduling the rehire of a terminated employee — sets the return-to-work date, confirms the work address, and chooses whether to file a new hire report. |
