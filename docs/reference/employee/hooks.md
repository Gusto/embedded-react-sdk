...
> **AccountNumberValidation** = _typeof_ [`BankFormErrorCodes`](#bankformerrorcodes)\[keyof `Pick`\<_typeof_ [`BankFormErrorCodes`](#bankformerrorcodes), `"REQUIRED"` \| `"INVALID_ACCOUNT_NUMBER"`\>\]
...
> **AccountType** = _typeof_ [`ACCOUNT_TYPES`](#account_types)\[`number`\]
...
> **BankFormErrorCode** = _typeof_ [`BankFormErrorCodes`](#bankformerrorcodes)\[keyof _typeof_ [`BankFormErrorCodes`](#bankformerrorcodes)\]
...
> **BankFormField** = keyof _typeof_ `fieldValidators`
...
> **BankFormOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **BankFormRequiredValidation** = _typeof_ `BankFormErrorCodes.REQUIRED`
...
> **RoutingNumberValidation** = _typeof_ [`BankFormErrorCodes`](#bankformerrorcodes)\[keyof `Pick`\<_typeof_ [`BankFormErrorCodes`](#bankformerrorcodes), `"REQUIRED"` \| `"INVALID_ROUTING_NUMBER"`\>\]
...
> **DeductionFormErrorCode** = _typeof_ [`DeductionFormErrorCodes`](#deductionformerrorcodes)\[keyof _typeof_ [`DeductionFormErrorCodes`](#deductionformerrorcodes)\]
...
> **DeductionFormNegativeAmountValidation** = _typeof_ `DeductionFormErrorCodes.NEGATIVE_AMOUNT`
...
> **DeductionFormOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **DeductionFormRequiredValidation** = _typeof_ `DeductionFormErrorCodes.REQUIRED`
...
> **ChildSupportGarnishmentFormErrorCode** = _typeof_ [`ChildSupportGarnishmentFormErrorCodes`](#childsupportgarnishmentformerrorcodes)\[keyof _typeof_ [`ChildSupportGarnishmentFormErrorCodes`](#childsupportgarnishmentformerrorcodes)\]
...
> **ChildSupportGarnishmentNegativeAmountValidation** = _typeof_ `ChildSupportGarnishmentFormErrorCodes.NEGATIVE_AMOUNT`
...
> **ChildSupportGarnishmentPercentValidation** = _typeof_ `ChildSupportGarnishmentFormErrorCodes.PERCENT_OUT_OF_RANGE`
...
> **ChildSupportGarnishmentRequiredValidation** = _typeof_ `ChildSupportGarnishmentFormErrorCodes.REQUIRED`
...
> **SupportedRequiredAttrKey** = _typeof_ [`SUPPORTED_REQUIRED_ATTR_KEYS`](#supported_required_attr_keys)\[`number`\]
...
> **HomeAddressErrorCode** = _typeof_ [`HomeAddressErrorCodes`](#homeaddresserrorcodes)\[keyof _typeof_ [`HomeAddressErrorCodes`](#homeaddresserrorcodes)\]
...
> **HomeAddressField** = keyof _typeof_ `fieldValidators`
...
> **HomeAddressOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **HomeAddressRequiredValidation** = _typeof_ `HomeAddressErrorCodes.REQUIRED`
...
> **ZipValidation** = _typeof_ [`HomeAddressErrorCodes`](#homeaddresserrorcodes)\[`"REQUIRED"` \| `"INVALID_ZIP"`\]
...
> `const` **PREPARER_FIELDS_BY_INDEX**: [`SignEmployeeFormField`](#signemployeeformfield)[][]
...
> **SignEmployeeFormErrorCode** = _typeof_ [`SignEmployeeFormErrorCodes`](#signemployeeformerrorcodes)\[keyof _typeof_ [`SignEmployeeFormErrorCodes`](#signemployeeformerrorcodes)\]
...
> **SignEmployeeFormField** = keyof _typeof_ `fieldValidators`
...
> **SignEmployeeFormRequiredValidation** = _typeof_ `SignEmployeeFormErrorCodes.REQUIRED`
...
> **EmployeeStateTaxesErrorCode** = _typeof_ [`EmployeeStateTaxesErrorCodes`](#employeestatetaxeserrorcodes)\[keyof _typeof_ [`EmployeeStateTaxesErrorCodes`](#employeestatetaxeserrorcodes)\]
...
> **EmailValidation** = _typeof_ [`EmployeeDetailsErrorCodes`](#employeedetailserrorcodes)\[`"REQUIRED"` \| `"INVALID_EMAIL"` \| `"EMAIL_REQUIRED_FOR_SELF_ONBOARDING"`\]
...
> **EmployeeDetailsErrorCode** = _typeof_ [`EmployeeDetailsErrorCodes`](#employeedetailserrorcodes)\[keyof _typeof_ [`EmployeeDetailsErrorCodes`](#employeedetailserrorcodes)\]
...
> **EmployeeDetailsField** = `Exclude`\<keyof _typeof_ `fieldValidators`, `"selfOnboarding"`\>
...
> **EmployeeDetailsOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **EmployeeDetailsRequiredValidation** = _typeof_ `EmployeeDetailsErrorCodes.REQUIRED`
...
> **NameValidation** = _typeof_ [`EmployeeDetailsErrorCodes`](#employeedetailserrorcodes)\[`"REQUIRED"` \| `"INVALID_NAME"`\]
...
> **SsnRequiredValidation** = _typeof_ `EmployeeDetailsErrorCodes.REQUIRED`
...
> **SsnValidation** = _typeof_ `EmployeeDetailsErrorCodes.INVALID_SSN`
...
> **FederalTaxesErrorCode** = _typeof_ [`FederalTaxesErrorCodes`](#federaltaxeserrorcodes)\[keyof _typeof_ [`FederalTaxesErrorCodes`](#federaltaxeserrorcodes)\]
...
> **FederalTaxesField** = keyof _typeof_ `fieldValidators`
...
> **FederalTaxesOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **FederalTaxesRequiredValidation** = _typeof_ `FederalTaxesErrorCodes.REQUIRED`
...
> **FilingStatusValue** = _typeof_ [`FILING_STATUS_VALUES`](#filing_status_values)\[`number`\]
...
> **WorkAddressErrorCode** = _typeof_ [`WorkAddressErrorCodes`](#workaddresserrorcodes)\[keyof _typeof_ [`WorkAddressErrorCodes`](#workaddresserrorcodes)\]
...
> **WorkAddressField** = keyof _typeof_ `fieldValidators`
...
> **WorkAddressOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **WorkAddressRequiredValidation** = _typeof_ `WorkAddressErrorCodes.REQUIRED`
...
> **PaymentMethodFormErrorCode** = _typeof_ [`PaymentMethodFormErrorCodes`](#paymentmethodformerrorcodes)\[keyof _typeof_ [`PaymentMethodFormErrorCodes`](#paymentmethodformerrorcodes)\]
...
> **PaymentMethodFormField** = keyof _typeof_ `fieldValidators`
...
> **PaymentMethodFormOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **PaymentMethodFormRequiredValidation** = _typeof_ `PaymentMethodFormErrorCodes.REQUIRED`
...
> **PaymentMethodType** = _typeof_ [`PAYMENT_METHOD_TYPES`](#payment_method_types)\[`number`\]
    ...
    <SDKFormProvider formHookResult={splitForm}>
      ...
      >
        ...
        {Fields.splits.map(split => (
          <split.Field key={split.uuid} label={split.name ?? 'Account'} min={0} />
        ))}
...
> **SplitByValue** = _typeof_ [`SPLIT_BY_VALUES`](#split_by_values)\[`number`\]
...
> **SplitPaymentsFormErrorCode** = _typeof_ [`SplitPaymentsFormErrorCodes`](#splitpaymentsformerrorcodes)\[keyof _typeof_ [`SplitPaymentsFormErrorCodes`](#splitpaymentsformerrorcodes)\]
...
> **SplitPaymentsFormField** = keyof _typeof_ `fieldValidators`
...
> **SplitPaymentsFormOptionalFieldsToRequire** = `OptionalFieldsToRequire`\<_typeof_ `requiredFieldsConfig`\>
...
> **SplitPaymentsFormRequiredValidation** = _typeof_ `SplitPaymentsFormErrorCodes.REQUIRED`
