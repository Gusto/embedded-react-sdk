...
> **AddressDefaultValues** = [`RequireAtLeastOne`](../../components.md#requireatleastone)\<[`ContractorAddressFormData`](../hooks/use-contractor-address-form.md#contractoraddressformdata)\>
...
- [`BaseComponentInterface`](../../components.md#basecomponentinterface)\<`"Contractor.Profile"`\>
...
> **OnboardingFlowDefaultValues** = [`RequireAtLeastOne`](../../components.md#requireatleastone)\<\{ `address?`: [`AddressDefaultValues`](#addressdefaultvalues); `profile?`: `Partial`\<[`ContractorDetailsFormData`](../hooks/use-contractor-details-form.md#contractordetailsformdata)\>; \}\>
