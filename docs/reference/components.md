...
title: Components
description: All flow and block components across every SDK domain. Flows guide users through multi-step tasks; blocks let you compose individual steps into a custom UI.
sidebar_position: 6
