...
| [Event Handling](./event-handling.md)                   | How to work with SDK events, useful for: Tracking and analytics Running side effects in your app ([Event Types Reference](../api/events.md))                                                            |
