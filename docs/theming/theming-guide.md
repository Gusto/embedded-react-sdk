...
For a complete inventory of available variables, see [theme variables](../api/theme-variables.md).
...
See [theme variables](../api/theme-variables.md) for a complete list of available variables.
