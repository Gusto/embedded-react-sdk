...
| **className**      | `string`                     | No       | CSS className to be applied                                                        |
| **selectionMode**  | `"checkbox" \| "radio"`      | No       | Selection mode: 'checkbox' for multi-select, 'radio' for single-select             |
| **radioGroupName** | `string`                     | No       | Radio group name for radio selection mode (required when selectionMode is 'radio') |
| **isSelected**     | `boolean`                    | No       | Whether this card is currently selected (used for radio mode)                      |
