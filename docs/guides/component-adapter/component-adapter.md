...
> Component adapters are powerful but can be complicated to set up and involve higher maintenance overhead. It is recommended to start with [theming](../theming.md) and then only use component adapters as needed.
