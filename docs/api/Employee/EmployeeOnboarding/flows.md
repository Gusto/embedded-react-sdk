...
| `companyId` | `string` | The associated company identifier. |
| `defaultValues?` | [`RequireAtLeastOne`](../../index.md#requireatleastone)\<[`OnboardingDefaultValues`](blocks.md#onboardingdefaultvalues)\> | Default values for individual flow step components. |
