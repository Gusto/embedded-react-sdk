...
- [`CommonComponentInterface`](../../index.md#commoncomponentinterface)\<`"Contractor.ContractorList"`\>
...
- [`CommonComponentInterface`](../../index.md#commoncomponentinterface)\<`"Contractor.Profile"`\>
...
- [`CommonComponentInterface`](../../index.md#commoncomponentinterface)\<`"Contractor.Submit"`\>
...
> **AddressDefaultValues** = [`RequireAtLeastOne`](../../index.md#requireatleastone)\<`Pick`\<`ContractorAddress`, `"street1"` \| `"street2"` \| `"city"` \| `"state"` \| `"zip"`\>\>
...
> **OnboardingFlowDefaultValues** = [`RequireAtLeastOne`](../../index.md#requireatleastone)\<\{ `address?`: [`AddressDefaultValues`](#addressdefaultvalues); `profile?`: `Partial`\<[`ContractorProfileFormData`](#contractorprofileformdata)\>; \}\>
