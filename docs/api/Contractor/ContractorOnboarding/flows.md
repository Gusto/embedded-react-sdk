...
title: ContractorOnboarding Flows
description: ContractorOnboarding Flows API reference.
...
| `defaultValues?` | [`RequireAtLeastOne`](../../index.md#requireatleastone)\<[`OnboardingFlowDefaultValues`](blocks.md#onboardingflowdefaultvalues)\> | Default values for individual flow step components — `profile` and/or `address` sub-objects. |
