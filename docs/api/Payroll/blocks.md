...
title: Payroll Blocks
description: Payroll Blocks API reference.
...
- [`BaseComponentInterface`](../index.md#basecomponentinterface)\<`"Payroll.PayrollConfiguration"`\>
...
- [`BaseComponentInterface`](../index.md#basecomponentinterface)\<`"Payroll.PayrollEditEmployee"`\>
...
Entry point for [PayrollExecutionFlow](flows.md#payrollexecutionflow). Determines which screen the flow renders first.
