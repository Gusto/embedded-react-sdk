...
The Gusto Embedded Payroll React SDK is a React component library for building embedded payroll experiences on top of the Gusto Embedded API. It offers three levels of abstraction — workflows, blocks, and hooks — so you can choose the right balance of speed and customization for each part of your application.
...
- **Blocks** — compose exactly the UI your application needs using individual form and data components, with full control over layout and sequencing.
...
See [Quick Start](./getting-started/quick-start.md) to install and configure the SDK for your application, or explore the [Example App](./getting-started/example-app.md) for a complete, runnable reference that orchestrates multiple workflows together.
