---
title: Payroll.TransitionCreation
sidebar_position: 19
---

Form for creating a transition payroll when changing pay schedules. Handles the gap period between the old and new pay schedule to ensure employees are paid correctly during the transition.
