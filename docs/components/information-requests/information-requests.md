...
The Information Requests domain provides components for responding to tax agency notices and other information requests that require action from the company. These components handle listing pending requests, displaying request details, and submitting responses.
