...
export const BLOCK_ENDPOINTS: Record<string, Endpoint[]> = {
  // --- Employee blocks ---
...
function blockEndpoints(name: string): Endpoint[] {
  const endpoints = BLOCK_ENDPOINTS[name]
  if (!endpoints) {
...
export const FLOW_ENDPOINTS: Record<string, Endpoint[]> = {
