...
export interface ContractorPaymentsHistoricalPaymentsCreateHistoricalPayment{
"title":string;
"description":string;
"emptyTableTitle":string;
"emptyTableDescription":string;
...
export interface ContractorPaymentsHistoricalPaymentsHistoricalPaymentFlow{
"breadcrumbLabel":string;
};
