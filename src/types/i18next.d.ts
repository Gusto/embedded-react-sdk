...
export interface TerminationsTerminateEmployee{
"title":string;
"subtitle":string;
"form":{
"lastDayOfEmployment":{
...
export interface TerminationsTerminationFlow{
"cancelSuccess":string;
};
export interface TerminationsTerminationSummary{
"title":string;
"subtitle":string;
"alert":{
"success":{
