...
export interface UNSTABLEHomeAddressForm{
"addTitle":string;
"editTitle":string;
"desc":string;
"street1Label":string;
...
export interface UNSTABLEPayScheduleForm{
"addTitle":string;
"editTitle":string;
"saveCta":string;
"labels":{
...
"frequencies":{
"Every week":string;
"Every other week":string;
"Twice per month":string;
"Monthly":string;
};
"payPreview":{
"payPeriod":string;
...
export interface UNSTABLESignCompanyForm{
"title":string;
"viewDocumentCta":string;
"signatureLabel":string;
"signatureDescription":string;
"confirmSignatureLabel":string;
"submitCta":string;
"fieldValidations":{
"signature":{
"REQUIRED":string;
...
export interface UNSTABLESignEmployeeForm{
"title":string;
"downloadInstructions":string;
"viewDocumentCta":string;
"signatureLabel":string;
...
export interface UNSTABLESignEmployeeI9Form{
"title":string;
"downloadInstructions":string;
"viewDocumentCta":string;
"signatureLabel":string;
