// This file is autogenerated        
        ...
        declare module 'i18next' {
            export interface CompanyAddBank{ "title":string;
"intro":string;
...
"submit":string; }; export interface CompanyAddresses{ "title":string;
"description":string;
"mailingLabel":string;
"filingLabel":string;
"editCta":string;
"addCta":string;
"continueCta":string; }; export interface CompanyFederalTaxes{ "pageTitle":string;
...
"non_profit":string;
"cancelCta":string; }; export interface CompanyIndustry{ "pageTitle":string;
"sectionTitle":string;
"desc":string;
"placeholder":string;
"cancelCta":string;
"continueCta":string; }; export interface EmployeeBankAccount{ "accountNumberLabel":string;
...
"submitCta":string;
"title":string;
"validations":{"accountType":string;} }; export interface EmployeeCompensation{ "addAnotherJobCta":string;
"allCompensations":{"actionColumn":string;
"amountColumn":string;
"deleteCta":string;
"editCta":string;
"jobColumn":string;
...
"flsaStatusLabels":{"Commission Only Exempt":string;
...
"paymentUnitOptions":{"Hour":string;
"Month":string;
"Paycheck":string;
"Week":string;
"Year":string;}
...
"submitCta":string;
"title":string;
"validations":{"classificationChangeNotification":string;
"exemptThreshold":string;
"paymentUnit":string;
"title":string;} }; export interface EmployeeDeductions{ "pageTitle":string;
...
"cancelCta":string;
"validations":{"description":string;
"amount":string;} }; export interface EmployeeEmployeeList{ "actionLabel":string;
...
"nameLabel":string;
"statusLabel":string;
"title":string; }; export interface EmployeeHomeAddress{ "formTitle":string;
"desc":string;
"street1":string;
"street2":string;
"city":string;
...
"cancel":string;
"submit":string;
"validations":{"street1":string;
"city":string;
"state":string;
"zip":string;} }; export interface EmployeeLanding{ "landingSubtitle":string;
"landingDescription":string;
"stepsSubtitle":string;
"steps":{"personalInfo":string;
"taxInfo":string;
"bankInfo":string;}
"getStartedCta":string;
"getStartedDescription":string; }; export interface EmployeeOnboardingSummary{ "subTitle":string;
"description":string;
...
"file_new_hire_report":string;} }; export interface EmployeePaySchedules{ "pageTitle":string;
"saveAndContinueCta":string;
"pleaseVerify":string;
"labels":{"frequency":string;
"firstPayDate":string;
"deadline":string;} }; export interface EmployeePaymentMethod{ "accountNumberLabel":string;
...
"validations":{"percentageError":string;
"amountError":string;
"accountName":string;
"routingNumber":string;
"accountNumber":string;} }; export interface EmployeeProfile{ "cancelCta":string;
"description":string;
"dobLabel":string;
"email":string;
...
"submitCta":string;
"title":string;
"validations":{"email":string;
"firstName":string;
"lastName":string;
"startDate":string;}
"workAddress":string;
"workAddressDescription":string;
"workAddressPlaceholder":string; }; export interface EmployeeSplitPaycheck{ "amountLabel":string;
...
"amountError":string;}
"cancelCta":string;
"submitCta":string; }; export interface EmployeeStateTaxes{ "title":string;
"filingStatusLabel":string;
"cancelCta":string;
"submitCta":string; }; export interface EmployeeTaxes{ "cancelCta":string;
"deductions":string;
...
"validations":{"federalFilingStatus":string;
"federalTwoJobs":string;} }; export interface PayrollPayrollHistoryList{ "period":string;
"payrollType":string;
"payrollCancellable":string;
"checkDate":string;
"payrollTotal":string; }; export interface PayrollPayrollSchedule{ "pageTitle":string;
"helpOne":string;
"helpTwo":string;
"helpThree":string;
"payFrequency":string;
...
"anchor_end_of_pay_period.help":string; }; export interface common{ "status":{"loading":string;
"requiredField":string;
"errorEncountered":string;}
"optionalLabel":string;
"errors":{"globalReactError":string;
"missingParamsOrContext":string;
"unhandledEvent":string;
"unknownEventType":string;}
"icons":{"selectArrow":string;
"calendarArrow":string;
"nextMonth":string;
"previousMonth":string;
"magnifyingGlass":string;}
"flows":{"employeeOnboarding":{"employeeListTitle":string;
"profileTitle":string;
...
"yes":string;
"no":string;}
"onboardingStatus":{"undefined":string;
...
"validations":{"accountName":string;
"routingNumber":string;
"accountNumber":string;
"ssn":string;
"location":string;
"dob":string;}
"statesHash":{"AL":string;
"AK":string;
"AZ":string;
"AR":string;
"CA":string;
