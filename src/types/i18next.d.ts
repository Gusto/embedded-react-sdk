...
export interface EmployeeProfileManagement{
"title":string;
"editCta":string;
"legalName":string;
"startDate":string;
...
export interface EmployeeSignatureForm{
"signatureFormTitle":string;
"downloadPrompt":string;
"signatureFieldLabel":string;
"signatureFieldDescription":string;
