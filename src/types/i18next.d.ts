...
export interface CompanyUNSTABLE_SignatoryForm{
"signatoryDetails":{
"title":string;
"description":string;
"firstName":string;
...
export interface EmployeeCompensationFields{
"jobTitle":string;
"employeeClassification":string;
"classificationLink":string;
"amount":string;
...
"MINIMUM_WAGE_REQUIRED":string;
"STATE_WC_CLASS_CODE_REQUIRED":string;
"INVALID_PAYMENT_UNIT_FOR_FLSA":string;
};
};
...
export interface EmployeeEmployeeDetailsFields{
"firstName":string;
...
export interface EmployeeHomeAddressFields{
"street1":string;
"street2":string;
"city":string;
"state":string;
...
export interface EmployeeUNSTABLE_AdminProfile{
"title":string;
"description":string;
"selfOnboardingLabel":string;
"selfOnboardingDescription":string;
...
export interface EmployeeUNSTABLE_CompensationForm{
"addTitle":string;
"editTitle":string;
"submitCta":string;
};
export interface EmployeeUNSTABLE_EmployeeProfile{
"title":string;
"description":string;
"personalDetails":{
"title":string;
...
export interface EmployeeWorkAddressFields{
"workAddress":string;
"workAddressDescription":string;
"workAddressPlaceholder":string;
"startDate":string;
