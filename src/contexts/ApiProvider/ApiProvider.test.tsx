...
describe('ApiProvider', () => {
  ...
  test('registers hooks with SDK when provided', async () => {
    const { GustoEmbeddedCore } = await import('@gusto/embedded-api-v-2026-06-15/core')
