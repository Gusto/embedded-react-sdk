...
import type { ProgressBreadcrumbsProps } from '@/components/Common/UI/ProgressBreadcrumbs'
import { ProgressBreadcrumbs } from '@/components/Common/UI/ProgressBreadcrumbs'
...
export const defaultComponents: ComponentsContextType = {
  ...
  ProgressBreadcrumbs: (props: ProgressBreadcrumbsProps) => <ProgressBreadcrumbs {...props} />,
