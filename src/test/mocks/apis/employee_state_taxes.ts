...
import type { GetV1EmployeesEmployeeIdStateTaxesRequest } from '@gusto/embedded-api-v-2025-11-15/models/operations/getv1employeesemployeeidstatetaxes'
import type { PutV1EmployeesEmployeeIdStateTaxesRequest } from '@gusto/embedded-api-v-2025-11-15/models/operations/putv1employeesemployeeidstatetaxes'
