...
import type { GetV1EmployeesEmployeeIdFederalTaxesRequest } from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1employeesemployeeidfederaltaxes'
import type { PutV1EmployeesEmployeeIdFederalTaxesRequestBody } from '@gusto/embedded-api-v-2026-06-15/models/operations/putv1employeesemployeeidfederaltaxes'
