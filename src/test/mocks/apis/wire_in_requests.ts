...
import type { GetCompaniesCompanyUuidWireInRequestUuidRequest } from '@gusto/embedded-api-v-2026-06-15/models/operations/getcompaniescompanyuuidwireinrequestuuid'
