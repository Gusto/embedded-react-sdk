  ...
  return HttpResponse.json(
    {
      contractor: {
        ...
        version: '1.0',
        type: requestBody.type || 'Business',
        wage_type: requestBody.wageType || 'Fixed',
        start_date: requestBody.startDate || '2024-01-01',
        ...
        file_new_hire_report: requestBody.fileNewHireReport ?? false,
      },
    },
    { status: 201 },
  )
