...
import type { GetV1CompaniesCompanyUuidSignatoriesRequest } from '@gusto/embedded-api-v-2025-11-15/models/operations/getv1companiescompanyuuidsignatories'
import type { SignatoryCreateRequest } from '@gusto/embedded-api-v-2025-11-15/models/components/signatorycreaterequest'
import type { SignatoryUpdateRequest } from '@gusto/embedded-api-v-2025-11-15/models/components/signatoryupdaterequest'
import type { SignatoryInviteRequest } from '@gusto/embedded-api-v-2025-11-15/models/components/signatoryinviterequest'
import type {
  DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest,
  DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse,
} from '@gusto/embedded-api-v-2025-11-15/models/operations/deletev1companiescompanyuuidsignatoriessignatoryuuid'
