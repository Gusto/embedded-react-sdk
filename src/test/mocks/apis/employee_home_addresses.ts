...
} from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1employeesemployeeidhomeaddresses'
import type {
  GetV1HomeAddressesHomeAddressUuidRequest,
  GetV1HomeAddressesHomeAddressUuidResponse,
} from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1homeaddresseshomeaddressuuid'
import type { PostV1EmployeesEmployeeIdHomeAddressesRequestBody } from '@gusto/embedded-api-v-2026-06-15/models/operations/postv1employeesemployeeidhomeaddresses'
import type { PutV1HomeAddressesHomeAddressUuidRequestBody } from '@gusto/embedded-api-v-2026-06-15/models/operations/putv1homeaddresseshomeaddressuuid'
import type {
  DeleteV1HomeAddressesHomeAddressUuidRequest,
  DeleteV1HomeAddressesHomeAddressUuidResponse,
} from '@gusto/embedded-api-v-2026-06-15/models/operations/deletev1homeaddresseshomeaddressuuid'
