...
import type { GetV1CompaniesCompanyIdFederalTaxDetailsRequest } from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1companiescompanyidfederaltaxdetails'
import type { FederalTaxDetailsUpdate } from '@gusto/embedded-api-v-2026-06-15/models/components/federaltaxdetailsupdate'
