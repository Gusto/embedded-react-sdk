...
import type { GetV1CompaniesCompanyIdPaySchedulesRequest } from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1companiescompanyidpayschedules'
import type { PayScheduleCreateRequest } from '@gusto/embedded-api-v-2026-06-15/models/components/payschedulecreaterequest'
import type { PayScheduleUpdateRequest } from '@gusto/embedded-api-v-2026-06-15/models/components/payscheduleupdaterequest'
import type { GetV1CompaniesCompanyIdPaySchedulesPreviewRequest } from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1companiescompanyidpayschedulespreview'
