...
import type { GetV1EmployeesEmployeeIdWorkAddressesRequest } from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1employeesemployeeidworkaddresses'
import type { GetV1WorkAddressesWorkAddressUuidRequest } from '@gusto/embedded-api-v-2026-06-15/models/operations/getv1workaddressesworkaddressuuid'
import type {
  DeleteV1WorkAddressesWorkAddressUuidRequest,
  DeleteV1WorkAddressesWorkAddressUuidResponse,
} from '@gusto/embedded-api-v-2026-06-15/models/operations/deletev1workaddressesworkaddressuuid'
import type { PutV1WorkAddressesWorkAddressUuidRequestBody } from '@gusto/embedded-api-v-2026-06-15/models/operations/putv1workaddressesworkaddressuuid'
import type { PostV1EmployeesEmployeeIdWorkAddressesRequestBody } from '@gusto/embedded-api-v-2026-06-15/models/operations/postv1employeesemployeeidworkaddresses'
