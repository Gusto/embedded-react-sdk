...
type RateValidation = 'REQUIRED' | 'RATE_MINIMUM' | 'RATE_EXEMPT_THRESHOLD'
...
export type FlsaStatusFieldProps = HookFieldProps<SelectHookFieldProps<RequiredValidation, string>>
...
export type PaymentUnitFieldProps = HookFieldProps<SelectHookFieldProps<RequiredValidation, string>>
