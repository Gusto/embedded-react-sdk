  ...
  useEmployeesListSuspense: () => ({
    data: {
      showEmployees: [
        ...
        { uuid: 'emp-3', firstName: 'Carol', lastName: 'Davis', jobs: [] },
      ],
    },
  }),
}))

vi.mock('@gusto/embedded-api-v-2026-06-15/react-query/timeOffPoliciesRemoveEmployees', () => ({
...
vi.mock('@gusto/embedded-api-v-2026-06-15/react-query/timeOffPoliciesUpdateBalance', () => ({
