...
vi.mock('@gusto/embedded-api-v-2026-06-15/react-query/holidayPayPoliciesGet', () => ({
...
vi.mock('@gusto/embedded-api-v-2026-06-15/react-query/holidayPayPoliciesAddEmployees', () => ({
