...
export default {
  title: 'UI/Components/ButtonTertiary',
}
  ...
  return (
    <>
      ...
      <div className="container">
        <Components.ButtonTertiary {...props} {...interactionState} onClick={() => {}} />
...
export const Default = () => <ButtonStory onClick={() => {}}>Tertiary Button</ButtonStory>
