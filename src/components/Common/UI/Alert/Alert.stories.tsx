...
export const InfoWithoutChildren = () => {
  const { Alert } = useComponentContext()
  return <Alert status="info" label="This is an info alert without additional content" />
}
...
export const SuccessWithoutChildren = () => {
  const { Alert } = useComponentContext()
  return <Alert status="success" label="Success! Your action was completed." />
}
...
export const WarningWithoutChildren = () => {
  const { Alert } = useComponentContext()
  return <Alert status="warning" label="Warning: This action cannot be undone" />
}
...
export const ErrorWithoutChildren = () => {
  const { Alert } = useComponentContext()
  return <Alert status="error" label="Error: Something went wrong" />
}
