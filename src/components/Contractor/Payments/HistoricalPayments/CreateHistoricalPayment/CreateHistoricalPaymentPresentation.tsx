...
import { getContractorDisplayName, getMaxHistoricalDate, getMinHistoricalDate } from './helpers'
...
interface CreateHistoricalPaymentPresentationProps {
...
export const CreateHistoricalPaymentPresentation = ({
  contractors,
  paymentDate,
  contractorPayments,
  onPaymentDateChange,
  ...
  alerts,
  isLoading,
}: CreateHistoricalPaymentPresentationProps) => {
  ...
  return (
    <Flex flexDirection="column" gap={32}>
      ...
      <Flex flexDirection="column" gap={8}>
        ...
        />
        <Text variant="supporting">{t('dateHint')}</Text>
      </Flex>
