...
} from '@gusto/embedded-api-v-2026-06-15/react-query/informationRequestsSubmit'
import type { RequiredQuestions } from '@gusto/embedded-api-v-2026-06-15/models/components/informationrequest'
import { ResponseType } from '@gusto/embedded-api-v-2026-06-15/models/components/informationrequest'
import { ResponseType as SubmitResponseType } from '@gusto/embedded-api-v-2026-06-15/models/operations/submitinformationrequest'
