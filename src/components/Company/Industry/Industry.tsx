...
import { useIndustrySelectionGetSuspense } from '@gusto/embedded-api-v-2026-06-15/react-query/industrySelectionGet'
import { useIndustrySelectionUpdateMutation } from '@gusto/embedded-api-v-2026-06-15/react-query/industrySelectionUpdate'
