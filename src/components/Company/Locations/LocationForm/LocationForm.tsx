...
import { useLocationsUpdateMutation } from '@gusto/embedded-api-v-2026-06-15/react-query/locationsUpdate'
import { useLocationsRetrieveSuspense } from '@gusto/embedded-api-v-2026-06-15/react-query/locationsRetrieve'
import { useLocationsCreateMutation } from '@gusto/embedded-api-v-2026-06-15/react-query/locationsCreate'
    ...
    await baseSubmitHandler(data, async innerData => {
      ...
      const refreshLocationsCache = () =>
        queryClient.invalidateQueries({
          queryKey: ['@gusto/embedded-api-v-2026-06-15', 'Locations'],
          refetchType: 'all',
        })
