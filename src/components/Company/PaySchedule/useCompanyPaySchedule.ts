...
import { PayScheduleSchema, type PayScheduleDefaultValues } from './usePaySchedule'
import { useBase } from '@/components/Base'
import { componentEvents } from '@/shared/constants'
import { formatDateToStringDate } from '@/helpers/dateFormatting'

interface UseCompanyPayScheduleProps {
  companyId: string
  defaultValues?: PayScheduleDefaultValues
}

export function useCompanyPaySchedule({ companyId, defaultValues }: UseCompanyPayScheduleProps) {
