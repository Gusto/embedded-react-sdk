...
import { useEmployeePaymentMethodGetSuspense } from '@gusto/embedded-api-v-2025-11-15/react-query/employeePaymentMethodGet'
...
import { usePayrollsGetPayStubsSuspense } from '@gusto/embedded-api-v-2025-11-15/react-query/payrollsGetPayStubs'
import type { Job } from '@gusto/embedded-api-v-2025-11-15/models/components/job'
import type { Garnishment } from '@gusto/embedded-api-v-2025-11-15/models/components/garnishment'
import type { GetV1EmployeesEmployeeIdPaymentMethodResponse } from '@gusto/embedded-api-v-2025-11-15/models/operations/getv1employeesemployeeidpaymentmethod'
import type { GetV1EmployeesEmployeeIdBankAccountsResponse } from '@gusto/embedded-api-v-2025-11-15/models/operations/getv1employeesemployeeidbankaccounts'
