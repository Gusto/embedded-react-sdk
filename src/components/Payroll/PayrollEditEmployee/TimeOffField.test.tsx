...
const TestWrapper = ({
  ...
  timeOffEntry: { name?: string; hours?: string }
  employee: Employee
}) => {
...
describe('TimeOffField', () => {
  it('should render time off input field', () => {
    const timeOffEntry = { name: 'Vacation Hours', hours: '8.0' }
  ...
  it('should show remaining balance for accrual policies', () => {
    const timeOffEntry = { name: 'Vacation Hours', hours: '8.0' }
  ...
  it('should not show balance for unlimited policies', () => {
    const timeOffEntry = { name: 'Sick Hours', hours: '0.0' }
  ...
  it('should not show balance if no matching policy found', () => {
    const timeOffEntry = { name: 'Unknown Policy', hours: '8.0' }
