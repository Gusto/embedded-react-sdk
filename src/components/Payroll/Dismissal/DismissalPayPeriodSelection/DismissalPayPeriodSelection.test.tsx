...
vi.mock(
  '@gusto/embedded-api-v-2026-06-15/react-query/paySchedulesGetUnprocessedTerminationPeriods',
  () => ({
...
vi.mock('@gusto/embedded-api-v-2026-06-15/react-query/payrollsCreateOffCycle', () => ({
