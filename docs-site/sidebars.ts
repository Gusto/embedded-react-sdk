...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      ...
      items: [
        { type: 'html', value: 'Company hooks', className: 'sidebar-group-label' },
        'hooks/usePayScheduleForm',
        'hooks/useSignCompanyForm',
        { type: 'html', value: 'Employee hooks', className: 'sidebar-group-label' },
        'hooks/useEmployeeList',
        'hooks/useEmployeeDetailsForm',
        'hooks/useJobForm',
        'hooks/useCompensationForm',
        'hooks/useWorkAddressForm',
        'hooks/useFederalTaxesForm',
        'hooks/useEmployeeStateTaxesForm',
        'hooks/useSignEmployeeForm',
        'hooks/useBankForm',
        'hooks/usePaymentMethodForm',
        'hooks/useSplitPaymentsForm',
        'hooks/useDeductionForm',
        'hooks/useChildSupportGarnishmentForm',
      ],
    },
    {
      type: 'category',
      label: 'Customize',
      link: { type: 'doc', id: 'customize/customize' },
      items: [
        {
          type: 'category',
          label: 'Theming',
